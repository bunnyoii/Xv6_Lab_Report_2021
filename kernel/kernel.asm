...
0000000080000000 <_entry>:
    ...
    80000016:	748060ef          	jal	ra,8000675e <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	0fe080e7          	jalr	254(ra) # 80007158 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	19e080e7          	jalr	414(ra) # 8000720c <release>
}
    ...
    8000008e:	b84080e7          	jalr	-1148(ra) # 80006c0e <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	fd4080e7          	jalr	-44(ra) # 800070c8 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	02c080e7          	jalr	44(ra) # 80007158 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	0c8080e7          	jalr	200(ra) # 8000720c <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	09e080e7          	jalr	158(ra) # 8000720c <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000348:	f26080e7          	jalr	-218(ra) # 8000726a <lockfree_read4>
    ...
    80000368:	8f4080e7          	jalr	-1804(ra) # 80006c58 <printf>
  ...
  scheduler();        
    ...
    80000430:	232080e7          	jalr	562(ra) # 8000665e <pci_init>
    sockinit();
    80000434:	00006097          	auipc	ra,0x6
    80000438:	e20080e7          	jalr	-480(ra) # 80006254 <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004aa:	768080e7          	jalr	1896(ra) # 80006c0e <panic>
...
0000000080000600 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000062c:	5e6080e7          	jalr	1510(ra) # 80006c0e <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008ca:	348080e7          	jalr	840(ra) # 80006c0e <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000a0c:	206080e7          	jalr	518(ra) # 80006c0e <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b62:	0b0080e7          	jalr	176(ra) # 80006c0e <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dc2:	e50080e7          	jalr	-432(ra) # 80006c0e <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dee:	2de080e7          	jalr	734(ra) # 800070c8 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000e06:	2c6080e7          	jalr	710(ra) # 800070c8 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e3c:	290080e7          	jalr	656(ra) # 800070c8 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000eae:	262080e7          	jalr	610(ra) # 8000710c <push_off>
  ...
  pop_off();
    ...
    80000ec8:	2e8080e7          	jalr	744(ra) # 800071ac <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000eec:	324080e7          	jalr	804(ra) # 8000720c <release>
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f38:	224080e7          	jalr	548(ra) # 80007158 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000f52:	2be080e7          	jalr	702(ra) # 8000720c <release>
}
...
00000000800010aa <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010cc:	090080e7          	jalr	144(ra) # 80007158 <acquire>
    if(p->state == UNUSED) {
    ...
    800010da:	136080e7          	jalr	310(ra) # 8000720c <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001158:	0b8080e7          	jalr	184(ra) # 8000720c <release>
    return 0;
    ...
    80001170:	0a0080e7          	jalr	160(ra) # 8000720c <release>
    return 0;
...
0000000080001178 <userinit>:
{
  ...
  release(&p->lock);
    ...
    800011ec:	024080e7          	jalr	36(ra) # 8000720c <release>
}
...
000000008000126e <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001304:	f0c080e7          	jalr	-244(ra) # 8000720c <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001356:	eba080e7          	jalr	-326(ra) # 8000720c <release>
  acquire(&wait_lock);
    ...
    80001368:	df4080e7          	jalr	-524(ra) # 80007158 <acquire>
  np->parent = p;
    8000136c:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001370:	8526                	mv	a0,s1
    80001372:	00006097          	auipc	ra,0x6
    80001376:	e9a080e7          	jalr	-358(ra) # 8000720c <release>
  acquire(&np->lock);
    8000137a:	854e                	mv	a0,s3
    8000137c:	00006097          	auipc	ra,0x6
    80001380:	ddc080e7          	jalr	-548(ra) # 80007158 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001390:	e80080e7          	jalr	-384(ra) # 8000720c <release>
}
...
00000000800013aa <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000142c:	de4080e7          	jalr	-540(ra) # 8000720c <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000143e:	d1e080e7          	jalr	-738(ra) # 80007158 <acquire>
      if(p->state == RUNNABLE) {
...
000000008000144a <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001466:	c7c080e7          	jalr	-900(ra) # 800070de <holding>
...
0000000080001520 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001538:	c24080e7          	jalr	-988(ra) # 80007158 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    8000154e:	cc2080e7          	jalr	-830(ra) # 8000720c <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000157c:	be0080e7          	jalr	-1056(ra) # 80007158 <acquire>
  release(lk);
    80001580:	854a                	mv	a0,s2
    80001582:	00006097          	auipc	ra,0x6
    80001586:	c8a080e7          	jalr	-886(ra) # 8000720c <release>
  ...
  release(&p->lock);
    ...
    800015a4:	c6c080e7          	jalr	-916(ra) # 8000720c <release>
  acquire(lk);
    800015a8:	854a                	mv	a0,s2
    800015aa:	00006097          	auipc	ra,0x6
    800015ae:	bae080e7          	jalr	-1106(ra) # 80007158 <acquire>
}
...
00000000800015c0 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015f0:	b6c080e7          	jalr	-1172(ra) # 80007158 <acquire>
    havekids = 0;
    ...
    8000168e:	ace080e7          	jalr	-1330(ra) # 80007158 <acquire>
        if(np->state == ZOMBIE){
    ...
    8000169e:	b72080e7          	jalr	-1166(ra) # 8000720c <release>
        havekids = 1;
    ...
    800016ba:	b56080e7          	jalr	-1194(ra) # 8000720c <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000171c:	af4080e7          	jalr	-1292(ra) # 8000720c <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000173a:	a22080e7          	jalr	-1502(ra) # 80007158 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b8 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017f4:	41e080e7          	jalr	1054(ra) # 80006c0e <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    8000183e:	91e080e7          	jalr	-1762(ra) # 80007158 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    8000185e:	8fe080e7          	jalr	-1794(ra) # 80007158 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001872:	99e080e7          	jalr	-1634(ra) # 8000720c <release>
  sched();
  ...
  panic("zombie exit");
    ...
    8000188a:	388080e7          	jalr	904(ra) # 80006c0e <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018b4:	8a8080e7          	jalr	-1880(ra) # 80007158 <acquire>
    if(p->pid == pid){
    ...
    800018c4:	94c080e7          	jalr	-1716(ra) # 8000720c <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e6:	92a080e7          	jalr	-1750(ra) # 8000720c <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019ce:	28e080e7          	jalr	654(ra) # 80006c58 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a10:	24c080e7          	jalr	588(ra) # 80006c58 <printf>
    printf("\n");
    80001a14:	8552                	mv	a0,s4
    80001a16:	00005097          	auipc	ra,0x5
    80001a1a:	242080e7          	jalr	578(ra) # 80006c58 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae0:	5ec080e7          	jalr	1516(ra) # 800070c8 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bba:	5a2080e7          	jalr	1442(ra) # 80007158 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bda:	636080e7          	jalr	1590(ra) # 8000720c <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c4a:	012080e7          	jalr	18(ra) # 80006c58 <printf>
    80001c4e:	a029                	j	80001c58 <devintr+0x70>
      uartintr();
    80001c50:	00005097          	auipc	ra,0x5
    80001c54:	428080e7          	jalr	1064(ra) # 80007078 <uartintr>
      plic_complete(irq);
...
0000000080001c9c <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001cee:	580080e7          	jalr	1408(ra) # 8000726a <lockfree_read4>
    ...
    80001d02:	f10080e7          	jalr	-240(ra) # 80006c0e <panic>
    if(lockfree_read4(&p->killed))
    80001d06:	02850513          	addi	a0,a0,40
    80001d0a:	00005097          	auipc	ra,0x5
    80001d0e:	560080e7          	jalr	1376(ra) # 8000726a <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d38:	536080e7          	jalr	1334(ra) # 8000726a <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d82:	eda080e7          	jalr	-294(ra) # 80006c58 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d9a:	ec2080e7          	jalr	-318(ra) # 80006c58 <printf>
    p->killed = 1;
...
0000000080001dae <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e08:	e0a080e7          	jalr	-502(ra) # 80006c0e <panic>
    ...
    80001e18:	dfa080e7          	jalr	-518(ra) # 80006c0e <panic>
    printf("scause %p\n", scause);
    ...
    80001e2a:	e32080e7          	jalr	-462(ra) # 80006c58 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ede:	d34080e7          	jalr	-716(ra) # 80006c0e <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002046:	c16080e7          	jalr	-1002(ra) # 80006c58 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    8000216c:	ff0080e7          	jalr	-16(ra) # 80007158 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021c0:	050080e7          	jalr	80(ra) # 8000720c <release>
  return 0;
    ...
    800021e2:	02e080e7          	jalr	46(ra) # 8000720c <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002232:	f2a080e7          	jalr	-214(ra) # 80007158 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000224a:	fc6080e7          	jalr	-58(ra) # 8000720c <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002282:	e4a080e7          	jalr	-438(ra) # 800070c8 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000230a:	e52080e7          	jalr	-430(ra) # 80007158 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000234a:	ec6080e7          	jalr	-314(ra) # 8000720c <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002388:	88a080e7          	jalr	-1910(ra) # 80006c0e <panic>
      b->dev = dev;
    ...
    800023a8:	e68080e7          	jalr	-408(ra) # 8000720c <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002418:	7fa080e7          	jalr	2042(ra) # 80006c0e <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002450:	d0c080e7          	jalr	-756(ra) # 80007158 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249a:	d76080e7          	jalr	-650(ra) # 8000720c <release>
}
    ...
    800024b6:	75c080e7          	jalr	1884(ra) # 80006c0e <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d2:	c8a080e7          	jalr	-886(ra) # 80007158 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024e8:	d28080e7          	jalr	-728(ra) # 8000720c <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000250e:	c4e080e7          	jalr	-946(ra) # 80007158 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002524:	cec080e7          	jalr	-788(ra) # 8000720c <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025aa:	668080e7          	jalr	1640(ra) # 80006c0e <panic>
...
00000000800025ae <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002670:	5a2080e7          	jalr	1442(ra) # 80006c0e <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027b6:	45c080e7          	jalr	1116(ra) # 80006c0e <panic>
...
00000000800027ba <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027da:	982080e7          	jalr	-1662(ra) # 80007158 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002820:	9f0080e7          	jalr	-1552(ra) # 8000720c <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    80002850:	9c0080e7          	jalr	-1600(ra) # 8000720c <release>
}
    ...
    80002872:	3a0080e7          	jalr	928(ra) # 80006c0e <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800028f2:	320080e7          	jalr	800(ra) # 80006c0e <panic>
...
00000000800028f6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002918:	7b4080e7          	jalr	1972(ra) # 800070c8 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002956 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800029d6:	23c080e7          	jalr	572(ra) # 80006c0e <panic>
...
0000000080002ab0 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ac8:	694080e7          	jalr	1684(ra) # 80007158 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002ade:	732080e7          	jalr	1842(ra) # 8000720c <release>
}
...
0000000080002aee <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b2a:	0e8080e7          	jalr	232(ra) # 80006c0e <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bac:	066080e7          	jalr	102(ra) # 80006c0e <panic>
...
0000000080002bb0 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002bf8:	01a080e7          	jalr	26(ra) # 80006c0e <panic>
...
0000000080002ca8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002cc2:	49a080e7          	jalr	1178(ra) # 80007158 <acquire>
  ...
  release(&itable.lock);
    ...
    80002ce0:	530080e7          	jalr	1328(ra) # 8000720c <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d14:	4fc080e7          	jalr	1276(ra) # 8000720c <release>
    itrunc(ip);
    ...
    80002d4a:	412080e7          	jalr	1042(ra) # 80007158 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003008:	c0a080e7          	jalr	-1014(ra) # 80006c0e <panic>
    ...
    80003018:	bfa080e7          	jalr	-1030(ra) # 80006c0e <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
000000008000341c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003444:	c88080e7          	jalr	-888(ra) # 800070c8 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d8:	c84080e7          	jalr	-892(ra) # 80007158 <acquire>
  while(1){
    if(log.committing){
    ...
    80003530:	ce0080e7          	jalr	-800(ra) # 8000720c <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003560:	bfc080e7          	jalr	-1028(ra) # 80007158 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003588:	c88080e7          	jalr	-888(ra) # 8000720c <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035a0:	bbc080e7          	jalr	-1092(ra) # 80007158 <acquire>
    log.committing = 0;
    ...
    800035b8:	c58080e7          	jalr	-936(ra) # 8000720c <release>
}
    ...
    800035da:	638080e7          	jalr	1592(ra) # 80006c0e <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800035f6:	c1a080e7          	jalr	-998(ra) # 8000720c <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800036b4:	aa8080e7          	jalr	-1368(ra) # 80007158 <acquire>
  ...
  release(&log.lock);
    ...
    8000376e:	aa2080e7          	jalr	-1374(ra) # 8000720c <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000379c:	930080e7          	jalr	-1744(ra) # 800070c8 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037d0:	98c080e7          	jalr	-1652(ra) # 80007158 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800037fe:	a12080e7          	jalr	-1518(ra) # 8000720c <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003826:	936080e7          	jalr	-1738(ra) # 80007158 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    80003842:	9ce080e7          	jalr	-1586(ra) # 8000720c <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000386c:	8f0080e7          	jalr	-1808(ra) # 80007158 <acquire>
  ...
  release(&lk->lk);
    ...
    8000387c:	994080e7          	jalr	-1644(ra) # 8000720c <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038c4:	808080e7          	jalr	-2040(ra) # 800070c8 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038e6:	876080e7          	jalr	-1930(ra) # 80007158 <acquire>
  ...
  release(&ftable.lock);
    ...
    80003912:	8fe080e7          	jalr	-1794(ra) # 8000720c <release>
  return 0;
    ...
    8000392a:	8e6080e7          	jalr	-1818(ra) # 8000720c <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003952:	80a080e7          	jalr	-2038(ra) # 80007158 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000396c:	8a4080e7          	jalr	-1884(ra) # 8000720c <release>
  return f;
}
    ...
    80003988:	28a080e7          	jalr	650(ra) # 80006c0e <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ae:	7ae080e7          	jalr	1966(ra) # 80007158 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039ec:	824080e7          	jalr	-2012(ra) # 8000720c <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a0c:	99a080e7          	jalr	-1638(ra) # 800063a2 <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1c:	91a080e7          	jalr	-1766(ra) # 80006432 <sockread>
  ...
  return r;
    ...
    80003ba8:	06a080e7          	jalr	106(ra) # 80006c0e <panic>
    return -1;
    ...
    80003bbc:	12078263          	beqz	a5,80003ce0 <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bfe:	908080e7          	jalr	-1784(ra) # 80006502 <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003cdc:	f36080e7          	jalr	-202(ra) # 80006c0e <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d4c:	380080e7          	jalr	896(ra) # 800070c8 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003dda:	382080e7          	jalr	898(ra) # 80007158 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003dfe:	412080e7          	jalr	1042(ra) # 8000720c <release>
    kfree((char*)pi);
    ...
    80003e30:	3e0080e7          	jalr	992(ra) # 8000720c <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e66:	2f6080e7          	jalr	758(ra) # 80007158 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003e84:	38c080e7          	jalr	908(ra) # 8000720c <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f26:	2ea080e7          	jalr	746(ra) # 8000720c <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f5c:	200080e7          	jalr	512(ra) # 80007158 <acquire>
  ...
  release(&pi->lock);
    ...
    80003ff0:	220080e7          	jalr	544(ra) # 8000720c <release>
  return i;
}
    ...
    80004010:	200080e7          	jalr	512(ra) # 8000720c <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004118:	afa080e7          	jalr	-1286(ra) # 80006c0e <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000454a:	6c8080e7          	jalr	1736(ra) # 80006c0e <panic>
    dp->nlink++;  // for ".."
...
00000000800048b8 <sys_unlink>:
{
  ...
  return 0;
    ...
    800049e4:	22e080e7          	jalr	558(ra) # 80006c0e <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005022:	25e080e7          	jalr	606(ra) # 8000627c <sockalloc>
...
000000008000527c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000529a:	e32080e7          	jalr	-462(ra) # 800070c8 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    8000539c:	876080e7          	jalr	-1930(ra) # 80006c0e <panic>
    ...
    800053ac:	866080e7          	jalr	-1946(ra) # 80006c0e <panic>
    ...
    800053bc:	856080e7          	jalr	-1962(ra) # 80006c0e <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053fa:	d62080e7          	jalr	-670(ra) # 80007158 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005634:	bdc080e7          	jalr	-1060(ra) # 8000720c <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056ae:	aae080e7          	jalr	-1362(ra) # 80007158 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	ad0080e7          	jalr	-1328(ra) # 8000720c <release>
}
    ...
    8000575c:	4b6080e7          	jalr	1206(ra) # 80006c0e <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    80005784:	948080e7          	jalr	-1720(ra) # 800070c8 <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000583e:	45c080e7          	jalr	1116(ra) # 80005c96 <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005900:	312080e7          	jalr	786(ra) # 80006c0e <panic>
...
e1000_transmit(struct mbuf *m)
{
  ...
  acquire(&e1000_lock);
    ...
    80005922:	83a080e7          	jalr	-1990(ra) # 80007158 <acquire>
  tail = regs[E1000_TDT];
  ...
  if ((desc->status & E1000_TXD_STAT_DD) == 0) {
    ...
    80005948:	c3d1                	beqz	a5,800059cc <e1000_transmit+0xc8>
    release(&e1000_lock);
    return -1;
  }
  ...
  if (tx_mbufs[tail]) {
    ...
    80005962:	c509                	beqz	a0,8000596c <e1000_transmit+0x68>
    mbuffree(tx_mbufs[tail]);
    80005964:	00000097          	auipc	ra,0x0
    80005968:	38a080e7          	jalr	906(ra) # 80005cee <mbuffree>
  }
  // fill in the descriptor
  desc->addr = (uint64) m->head;
    8000596c:	00019517          	auipc	a0,0x19
    80005970:	69450513          	addi	a0,a0,1684 # 8001f000 <e1000_lock>
    80005974:	02049793          	slli	a5,s1,0x20
    80005978:	9381                	srli	a5,a5,0x20
    8000597a:	00479713          	slli	a4,a5,0x4
    8000597e:	972a                	add	a4,a4,a0
    80005980:	00893683          	ld	a3,8(s2)
    80005984:	f314                	sd	a3,32(a4)
  desc->length = m->len;
    80005986:	01092683          	lw	a3,16(s2)
    8000598a:	02d71423          	sh	a3,40(a4) # 4028 <_entry-0x7fffbfd8>
  desc->cmd = E1000_TXD_CMD_EOP | E1000_TXD_CMD_RS;
    8000598e:	46a5                	li	a3,9
    80005990:	02d705a3          	sb	a3,43(a4)
  tx_mbufs[tail] = m;
    80005994:	078e                	slli	a5,a5,0x3
    80005996:	97aa                	add	a5,a5,a0
    80005998:	1327b023          	sd	s2,288(a5)
  ...
  regs[E1000_TDT] = (tail + 1) % TX_RING_SIZE;
    800059a0:	2485                	addiw	s1,s1,1
    800059a2:	88bd                	andi	s1,s1,15
    800059a4:	00004797          	auipc	a5,0x4
    800059a8:	67c7b783          	ld	a5,1660(a5) # 8000a020 <regs>
    800059ac:	6711                	lui	a4,0x4
    800059ae:	97ba                	add	a5,a5,a4
    800059b0:	8097ac23          	sw	s1,-2024(a5)
  release(&e1000_lock);
    800059b4:	00002097          	auipc	ra,0x2
    800059b8:	858080e7          	jalr	-1960(ra) # 8000720c <release>
  
  return 0;
    800059bc:	4501                	li	a0,0
}
    800059be:	70a2                	ld	ra,40(sp)
    800059c0:	7402                	ld	s0,32(sp)
    800059c2:	64e2                	ld	s1,24(sp)
    800059c4:	6942                	ld	s2,16(sp)
    800059c6:	69a2                	ld	s3,8(sp)
    800059c8:	6145                	addi	sp,sp,48
    800059ca:	8082                	ret
    release(&e1000_lock);
    800059cc:	854e                	mv	a0,s3
    800059ce:	00002097          	auipc	ra,0x2
    800059d2:	83e080e7          	jalr	-1986(ra) # 8000720c <release>
    return -1;
    800059d6:	557d                	li	a0,-1
    800059d8:	b7dd                	j	800059be <e1000_transmit+0xba>
...
e1000_intr(void)
{
  ...
  struct rx_desc *desc = &rx_ring[tail];
    ...
    80005a0c:	00019917          	auipc	s2,0x19
    80005a10:	79490913          	addi	s2,s2,1940 # 8001f1a0 <rx_ring>
    80005a14:	993a                	add	s2,s2,a4
  while ((desc->status & E1000_RXD_STAT_DD)) {
    80005a16:	00019797          	auipc	a5,0x19
    80005a1a:	5ea78793          	addi	a5,a5,1514 # 8001f000 <e1000_lock>
    80005a1e:	97ba                	add	a5,a5,a4
    80005a20:	1ac7c783          	lbu	a5,428(a5)
    80005a24:	8b85                	andi	a5,a5,1
    80005a26:	cfa5                	beqz	a5,80005a9e <e1000_intr+0xc4>
    if(desc->length > MBUF_SIZE) {
    80005a28:	6a05                	lui	s4,0x1
    80005a2a:	800a0a13          	addi	s4,s4,-2048 # 800 <_entry-0x7ffff800>
    rx_mbufs[tail]->len = desc->length;
    80005a2e:	00019a97          	auipc	s5,0x19
    80005a32:	5d2a8a93          	addi	s5,s5,1490 # 8001f000 <e1000_lock>
    desc = &rx_ring[tail];
    80005a36:	00019b17          	auipc	s6,0x19
    80005a3a:	76ab0b13          	addi	s6,s6,1898 # 8001f1a0 <rx_ring>
    if(desc->length > MBUF_SIZE) {
    80005a3e:	00895783          	lhu	a5,8(s2)
    80005a42:	0007871b          	sext.w	a4,a5
    80005a46:	08ea6663          	bltu	s4,a4,80005ad2 <e1000_intr+0xf8>
    rx_mbufs[tail]->len = desc->length;
    80005a4a:	00349993          	slli	s3,s1,0x3
    80005a4e:	99d6                	add	s3,s3,s5
    80005a50:	2a09b703          	ld	a4,672(s3)
    80005a54:	cb1c                	sw	a5,16(a4)
    net_rx(rx_mbufs[tail]);     
    80005a56:	2a09b503          	ld	a0,672(s3)
    80005a5a:	00000097          	auipc	ra,0x0
    80005a5e:	408080e7          	jalr	1032(ra) # 80005e62 <net_rx>
    rx_mbufs[tail] = mbufalloc(0);
    80005a62:	4501                	li	a0,0
    80005a64:	00000097          	auipc	ra,0x0
    80005a68:	232080e7          	jalr	562(ra) # 80005c96 <mbufalloc>
    80005a6c:	2aa9b023          	sd	a0,672(s3)
    if (!rx_mbufs[tail]) {
    80005a70:	c92d                	beqz	a0,80005ae2 <e1000_intr+0x108>
    desc->addr = (uint64) rx_mbufs[tail]->head;
    80005a72:	651c                	ld	a5,8(a0)
    80005a74:	00f93023          	sd	a5,0(s2)
    desc->status = 0;
    80005a78:	00090623          	sb	zero,12(s2)
    tail = (tail + 1) % RX_RING_SIZE;
    80005a7c:	2485                	addiw	s1,s1,1
    80005a7e:	41f4d79b          	sraiw	a5,s1,0x1f
    80005a82:	01c7d79b          	srliw	a5,a5,0x1c
    80005a86:	9cbd                	addw	s1,s1,a5
    80005a88:	88bd                	andi	s1,s1,15
    80005a8a:	9c9d                	subw	s1,s1,a5
    desc = &rx_ring[tail];
    80005a8c:	00449793          	slli	a5,s1,0x4
    80005a90:	00fb0933          	add	s2,s6,a5
  while ((desc->status & E1000_RXD_STAT_DD)) {
    80005a94:	97d6                	add	a5,a5,s5
    80005a96:	1ac7c783          	lbu	a5,428(a5)
    80005a9a:	8b85                	andi	a5,a5,1
    80005a9c:	f3cd                	bnez	a5,80005a3e <e1000_intr+0x64>
  regs[E1000_RDT] = (tail - 1) % RX_RING_SIZE;
    80005a9e:	34fd                	addiw	s1,s1,-1
    80005aa0:	41f4d79b          	sraiw	a5,s1,0x1f
    80005aa4:	01c7d79b          	srliw	a5,a5,0x1c
    80005aa8:	9cbd                	addw	s1,s1,a5
    80005aaa:	88bd                	andi	s1,s1,15
    80005aac:	9c9d                	subw	s1,s1,a5
    80005aae:	00004797          	auipc	a5,0x4
    80005ab2:	5727b783          	ld	a5,1394(a5) # 8000a020 <regs>
    80005ab6:	670d                	lui	a4,0x3
    80005ab8:	97ba                	add	a5,a5,a4
    80005aba:	8097ac23          	sw	s1,-2024(a5)
  ...
  e1000_recv();
    ...
    80005ac4:	7902                	ld	s2,32(sp)
    80005ac6:	69e2                	ld	s3,24(sp)
    80005ac8:	6a42                	ld	s4,16(sp)
    80005aca:	6aa2                	ld	s5,8(sp)
    80005acc:	6b02                	ld	s6,0(sp)
    80005ace:	6121                	addi	sp,sp,64
    80005ad0:	8082                	ret
      panic("e1000 len");
    80005ad2:	00004517          	auipc	a0,0x4
    80005ad6:	d1650513          	addi	a0,a0,-746 # 800097e8 <syscalls+0x410>
    80005ada:	00001097          	auipc	ra,0x1
    80005ade:	134080e7          	jalr	308(ra) # 80006c0e <panic>
      panic("e1000 no mubfs");
    80005ae2:	00004517          	auipc	a0,0x4
    80005ae6:	d1650513          	addi	a0,a0,-746 # 800097f8 <syscalls+0x420>
    80005aea:	00001097          	auipc	ra,0x1
    80005aee:	124080e7          	jalr	292(ra) # 80006c0e <panic>

0000000080005af2 <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005af4:	ec22                	sd	s0,24(sp)
    80005af6:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005af8:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005afe:	04b7d963          	bge	a5,a1,80005b50 <in_cksum+0x5e>
    80005b02:	ffe5879b          	addiw	a5,a1,-2
    80005b06:	0017d61b          	srliw	a2,a5,0x1
    80005b0a:	0017d71b          	srliw	a4,a5,0x1
    80005b0e:	0705                	addi	a4,a4,1
    80005b10:	0706                	slli	a4,a4,0x1
    80005b12:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005b14:	4781                	li	a5,0
    sum += *w++;
    80005b16:	0509                	addi	a0,a0,2
    80005b18:	ffe55683          	lhu	a3,-2(a0)
    80005b1c:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005b1e:	fee51ce3          	bne	a0,a4,80005b16 <in_cksum+0x24>
    80005b22:	35f9                	addiw	a1,a1,-2
    80005b24:	0016169b          	slliw	a3,a2,0x1
    80005b28:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }

  /* mop up an odd byte, if necessary */
  if (nleft == 1) {
    80005b2a:	4685                	li	a3,1
    80005b2c:	02d58563          	beq	a1,a3,80005b56 <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005b30:	03079513          	slli	a0,a5,0x30
    80005b34:	9141                	srli	a0,a0,0x30
    80005b36:	0107d79b          	srliw	a5,a5,0x10
    80005b3a:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005b3c:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005b40:	9d3d                	addw	a0,a0,a5
    80005b42:	fff54513          	not	a0,a0
  return answer;
}
    80005b46:	1542                	slli	a0,a0,0x30
    80005b48:	9141                	srli	a0,a0,0x30
    80005b4a:	6462                	ld	s0,24(sp)
    80005b4c:	6105                	addi	sp,sp,32
    80005b4e:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b50:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b52:	4781                	li	a5,0
    80005b54:	bfd9                	j	80005b2a <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b56:	00074703          	lbu	a4,0(a4) # 3000 <_entry-0x7fffd000>
    80005b5a:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b5e:	fee45703          	lhu	a4,-18(s0)
    80005b62:	9fb9                	addw	a5,a5,a4
    80005b64:	b7f1                	j	80005b30 <in_cksum+0x3e>

0000000080005b66 <mbufpull>:
{
    80005b66:	1141                	addi	sp,sp,-16
    80005b68:	e422                	sd	s0,8(sp)
    80005b6a:	0800                	addi	s0,sp,16
    80005b6c:	87aa                	mv	a5,a0
  char *tmp = m->head;
    80005b6e:	6508                	ld	a0,8(a0)
  if (m->len < len)
    80005b70:	4b98                	lw	a4,16(a5)
    80005b72:	00b76b63          	bltu	a4,a1,80005b88 <mbufpull+0x22>
  m->len -= len;
    80005b76:	9f0d                	subw	a4,a4,a1
    80005b78:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b7a:	1582                	slli	a1,a1,0x20
    80005b7c:	9181                	srli	a1,a1,0x20
    80005b7e:	95aa                	add	a1,a1,a0
    80005b80:	e78c                	sd	a1,8(a5)
}
    80005b82:	6422                	ld	s0,8(sp)
    80005b84:	0141                	addi	sp,sp,16
    80005b86:	8082                	ret
    return 0;
    80005b88:	4501                	li	a0,0
    80005b8a:	bfe5                	j	80005b82 <mbufpull+0x1c>

0000000080005b8c <mbufpush>:
{
    80005b8c:	87aa                	mv	a5,a0
  m->head -= len;
    80005b8e:	02059713          	slli	a4,a1,0x20
    80005b92:	9301                	srli	a4,a4,0x20
    80005b94:	6508                	ld	a0,8(a0)
    80005b96:	8d19                	sub	a0,a0,a4
    80005b98:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005b9a:	01478713          	addi	a4,a5,20
    80005b9e:	00e56663          	bltu	a0,a4,80005baa <mbufpush+0x1e>
  m->len += len;
    80005ba2:	4b98                	lw	a4,16(a5)
    80005ba4:	9db9                	addw	a1,a1,a4
    80005ba6:	cb8c                	sw	a1,16(a5)
}
    80005ba8:	8082                	ret
{
    ...
    panic("mbufpush");
    80005bb2:	00004517          	auipc	a0,0x4
    80005bb6:	c5650513          	addi	a0,a0,-938 # 80009808 <syscalls+0x430>
    80005bba:	00001097          	auipc	ra,0x1
    80005bbe:	054080e7          	jalr	84(ra) # 80006c0e <panic>

0000000080005bc2 <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    ...
    80005bce:	1800                	addi	s0,sp,48
    80005bd0:	89aa                	mv	s3,a0
    80005bd2:	892e                	mv	s2,a1
  struct eth *ethhdr;

  ethhdr = mbufpushhdr(m, *ethhdr);
    80005bd4:	45b9                	li	a1,14
    80005bd6:	00000097          	auipc	ra,0x0
    80005bda:	fb6080e7          	jalr	-74(ra) # 80005b8c <mbufpush>
    80005bde:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005be0:	4619                	li	a2,6
    80005be2:	00004597          	auipc	a1,0x4
    80005be6:	cde58593          	addi	a1,a1,-802 # 800098c0 <local_mac>
    80005bea:	0519                	addi	a0,a0,6
    80005bec:	ffffa097          	auipc	ra,0xffffa
    80005bf0:	5ec080e7          	jalr	1516(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005bf4:	4619                	li	a2,6
    80005bf6:	00004597          	auipc	a1,0x4
    80005bfa:	cc258593          	addi	a1,a1,-830 # 800098b8 <broadcast_mac>
    80005bfe:	8526                	mv	a0,s1
    80005c00:	ffffa097          	auipc	ra,0xffffa
    80005c04:	5d8080e7          	jalr	1496(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005c08:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005c0c:	00f48623          	sb	a5,12(s1)
    80005c10:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005c14:	854e                	mv	a0,s3
    80005c16:	00000097          	auipc	ra,0x0
    80005c1a:	cee080e7          	jalr	-786(ra) # 80005904 <e1000_transmit>
    80005c1e:	e901                	bnez	a0,80005c2e <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
    ...
    80005c2c:	8082                	ret
  kfree(m);
    80005c2e:	854e                	mv	a0,s3
    80005c30:	ffffa097          	auipc	ra,0xffffa
    80005c34:	3ec080e7          	jalr	1004(ra) # 8000001c <kfree>
}
    80005c38:	b7e5                	j	80005c20 <net_tx_eth+0x5e>

0000000080005c3a <mbufput>:
{
    80005c3a:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005c3c:	4918                	lw	a4,16(a0)
    80005c3e:	02071693          	slli	a3,a4,0x20
    80005c42:	9281                	srli	a3,a3,0x20
    80005c44:	6508                	ld	a0,8(a0)
    80005c46:	9536                	add	a0,a0,a3
  m->len += len;
    80005c48:	9f2d                	addw	a4,a4,a1
    80005c4a:	0007069b          	sext.w	a3,a4
    80005c4e:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c50:	6785                	lui	a5,0x1
    80005c52:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c56:	00d7e363          	bltu	a5,a3,80005c5c <mbufput+0x22>
}
    80005c5a:	8082                	ret
{
    ...
    80005c68:	bb450513          	addi	a0,a0,-1100 # 80009818 <syscalls+0x440>
    80005c6c:	00001097          	auipc	ra,0x1
    80005c70:	fa2080e7          	jalr	-94(ra) # 80006c0e <panic>

0000000080005c74 <mbuftrim>:
{
    80005c74:	1141                	addi	sp,sp,-16
    80005c76:	e422                	sd	s0,8(sp)
    80005c78:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c7a:	491c                	lw	a5,16(a0)
    80005c7c:	00b7eb63          	bltu	a5,a1,80005c92 <mbuftrim+0x1e>
  m->len -= len;
    80005c80:	9f8d                	subw	a5,a5,a1
    80005c82:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c84:	1782                	slli	a5,a5,0x20
    80005c86:	9381                	srli	a5,a5,0x20
    80005c88:	6508                	ld	a0,8(a0)
    ...
    80005c94:	bfe5                	j	80005c8c <mbuftrim+0x18>

0000000080005c96 <mbufalloc>:
{
  ...
  if (headroom > MBUF_SIZE)
    80005ca2:	6785                	lui	a5,0x1
    80005ca4:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005ca8:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005caa:	02a7eb63          	bltu	a5,a0,80005ce0 <mbufalloc+0x4a>
    80005cae:	84aa                	mv	s1,a0
  m = kalloc();
    80005cb0:	ffffa097          	auipc	ra,0xffffa
    80005cb4:	468080e7          	jalr	1128(ra) # 80000118 <kalloc>
    80005cb8:	892a                	mv	s2,a0
  if (m == 0)
    80005cba:	c11d                	beqz	a0,80005ce0 <mbufalloc+0x4a>
  m->next = 0;
    80005cbc:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005cc0:	0551                	addi	a0,a0,20
    80005cc2:	1482                	slli	s1,s1,0x20
    80005cc4:	9081                	srli	s1,s1,0x20
    80005cc6:	94aa                	add	s1,s1,a0
    80005cc8:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005ccc:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005cd0:	6605                	lui	a2,0x1
    80005cd2:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005cd6:	4581                	li	a1,0
    80005cd8:	ffffa097          	auipc	ra,0xffffa
    80005cdc:	4a0080e7          	jalr	1184(ra) # 80000178 <memset>
}
    80005ce0:	854a                	mv	a0,s2
    80005ce2:	60e2                	ld	ra,24(sp)
    80005ce4:	6442                	ld	s0,16(sp)
    80005ce6:	64a2                	ld	s1,8(sp)
    80005ce8:	6902                	ld	s2,0(sp)
    80005cea:	6105                	addi	sp,sp,32
    80005cec:	8082                	ret

0000000080005cee <mbuffree>:
{
    80005cee:	1141                	addi	sp,sp,-16
    80005cf0:	e406                	sd	ra,8(sp)
    80005cf2:	e022                	sd	s0,0(sp)
    80005cf4:	0800                	addi	s0,sp,16
  kfree(m);
    80005cf6:	ffffa097          	auipc	ra,0xffffa
    80005cfa:	326080e7          	jalr	806(ra) # 8000001c <kfree>
}
...
0000000080005d06 <mbufq_pushtail>:
{
    80005d06:	1141                	addi	sp,sp,-16
    80005d08:	e422                	sd	s0,8(sp)
    80005d0a:	0800                	addi	s0,sp,16
  m->next = 0;
    80005d0c:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005d10:	611c                	ld	a5,0(a0)
    80005d12:	c799                	beqz	a5,80005d20 <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005d14:	651c                	ld	a5,8(a0)
    80005d16:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005d18:	e50c                	sd	a1,8(a0)
}
    80005d1a:	6422                	ld	s0,8(sp)
    80005d1c:	0141                	addi	sp,sp,16
    80005d1e:	8082                	ret
    q->head = q->tail = m;
    80005d20:	e50c                	sd	a1,8(a0)
    80005d22:	e10c                	sd	a1,0(a0)
    return;
    80005d24:	bfdd                	j	80005d1a <mbufq_pushtail+0x14>

0000000080005d26 <mbufq_pophead>:
{
  ...
  struct mbuf *head = q->head;
    80005d2e:	6108                	ld	a0,0(a0)
  if (!head)
    80005d30:	c119                	beqz	a0,80005d36 <mbufq_pophead+0x10>
  q->head = head->next;
    80005d32:	6118                	ld	a4,0(a0)
...
0000000080005d3c <mbufq_empty>:
{
    80005d3c:	1141                	addi	sp,sp,-16
    80005d3e:	e422                	sd	s0,8(sp)
    80005d40:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d42:	6108                	ld	a0,0(a0)
}
    80005d44:	00153513          	seqz	a0,a0
    80005d48:	6422                	ld	s0,8(sp)
    80005d4a:	0141                	addi	sp,sp,16
    80005d4c:	8082                	ret

0000000080005d4e <mbufq_init>:
{
  ...
  q->head = 0;
    ...
    80005d58:	6422                	ld	s0,8(sp)
    80005d5a:	0141                	addi	sp,sp,16
    80005d5c:	8082                	ret

0000000080005d5e <net_tx_udp>:
           ...
           uint16 sport, uint16 dport)
{
    ...
    80005d64:	ec26                	sd	s1,24(sp)
    80005d66:	e84a                	sd	s2,16(sp)
    80005d68:	e44e                	sd	s3,8(sp)
    80005d6a:	e052                	sd	s4,0(sp)
    80005d6c:	1800                	addi	s0,sp,48
    80005d6e:	8a2a                	mv	s4,a0
    80005d70:	892e                	mv	s2,a1
    80005d72:	89b2                	mv	s3,a2
    80005d74:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d76:	45a1                	li	a1,8
    80005d78:	00000097          	auipc	ra,0x0
    80005d7c:	e14080e7          	jalr	-492(ra) # 80005b8c <mbufpush>
    80005d80:	0089d61b          	srliw	a2,s3,0x8
    80005d84:	0089999b          	slliw	s3,s3,0x8
    80005d88:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d8c:	01351023          	sh	s3,0(a0)
    80005d90:	0084d69b          	srliw	a3,s1,0x8
    80005d94:	0084949b          	slliw	s1,s1,0x8
    80005d98:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005d9a:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005d9e:	010a2783          	lw	a5,16(s4)
    80005da2:	0087d713          	srli	a4,a5,0x8
    80005da6:	0087979b          	slliw	a5,a5,0x8
    80005daa:	0ff77713          	andi	a4,a4,255
    80005dae:	8fd9                	or	a5,a5,a4
    80005db0:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005db4:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005db8:	45d1                	li	a1,20
    80005dba:	8552                	mv	a0,s4
    80005dbc:	00000097          	auipc	ra,0x0
    80005dc0:	dd0080e7          	jalr	-560(ra) # 80005b8c <mbufpush>
    80005dc4:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005dc6:	4651                	li	a2,20
    80005dc8:	4581                	li	a1,0
    80005dca:	ffffa097          	auipc	ra,0xffffa
    80005dce:	3ae080e7          	jalr	942(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005dd2:	04500793          	li	a5,69
    80005dd6:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005dda:	47c5                	li	a5,17
    80005ddc:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005de0:	0f0207b7          	lui	a5,0xf020
    80005de4:	27a9                	addiw	a5,a5,10
    80005de6:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005de8:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005dec:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005df0:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005df2:	0089171b          	slliw	a4,s2,0x8
    80005df6:	00ff06b7          	lui	a3,0xff0
    80005dfa:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005dfc:	8fd9                	or	a5,a5,a4
    80005dfe:	0089591b          	srliw	s2,s2,0x8
    80005e02:	65c1                	lui	a1,0x10
    80005e04:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005e08:	00b97933          	and	s2,s2,a1
    80005e0c:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005e10:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005e14:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005e18:	0087d713          	srli	a4,a5,0x8
    80005e1c:	0087979b          	slliw	a5,a5,0x8
    80005e20:	0ff77713          	andi	a4,a4,255
    80005e24:	8fd9                	or	a5,a5,a4
    80005e26:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005e2a:	06400793          	li	a5,100
    80005e2e:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005e32:	45d1                	li	a1,20
    80005e34:	8526                	mv	a0,s1
    80005e36:	00000097          	auipc	ra,0x0
    80005e3a:	cbc080e7          	jalr	-836(ra) # 80005af2 <in_cksum>
    80005e3e:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005e42:	6585                	lui	a1,0x1
    80005e44:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005e48:	8552                	mv	a0,s4
    80005e4a:	00000097          	auipc	ra,0x0
    80005e4e:	d78080e7          	jalr	-648(ra) # 80005bc2 <net_tx_eth>
  ...
  net_tx_ip(m, IPPROTO_UDP, dip);
    ...
    80005e5a:	69a2                	ld	s3,8(sp)
    80005e5c:	6a02                	ld	s4,0(sp)
    80005e5e:	6145                	addi	sp,sp,48
    80005e60:	8082                	ret

0000000080005e62 <net_rx>:
}
...
{
    80005e62:	715d                	addi	sp,sp,-80
    80005e64:	e486                	sd	ra,72(sp)
    80005e66:	e0a2                	sd	s0,64(sp)
    80005e68:	fc26                	sd	s1,56(sp)
    80005e6a:	f84a                	sd	s2,48(sp)
    80005e6c:	f44e                	sd	s3,40(sp)
    80005e6e:	f052                	sd	s4,32(sp)
    80005e70:	ec56                	sd	s5,24(sp)
  ...
  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e76:	45b9                	li	a1,14
    80005e78:	00000097          	auipc	ra,0x0
    80005e7c:	cee080e7          	jalr	-786(ra) # 80005b66 <mbufpull>
  if (!ethhdr) {
    80005e80:	c521                	beqz	a0,80005ec8 <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e82:	00c54783          	lbu	a5,12(a0)
    80005e86:	00d54703          	lbu	a4,13(a0)
    80005e8a:	0722                	slli	a4,a4,0x8
    80005e8c:	8fd9                	or	a5,a5,a4
    80005e8e:	0087979b          	slliw	a5,a5,0x8
    80005e92:	8321                	srli	a4,a4,0x8
    80005e94:	8fd9                	or	a5,a5,a4
    80005e96:	17c2                	slli	a5,a5,0x30
    80005e98:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005e9a:	8007871b          	addiw	a4,a5,-2048
    80005e9e:	cb1d                	beqz	a4,80005ed4 <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005ea0:	2781                	sext.w	a5,a5
    80005ea2:	6705                	lui	a4,0x1
    80005ea4:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005ea8:	18e78e63          	beq	a5,a4,80006044 <net_rx+0x1e2>
  kfree(m);
    ...
    80005eb6:	60a6                	ld	ra,72(sp)
    80005eb8:	6406                	ld	s0,64(sp)
    80005eba:	74e2                	ld	s1,56(sp)
    80005ebc:	7942                	ld	s2,48(sp)
    80005ebe:	79a2                	ld	s3,40(sp)
    80005ec0:	7a02                	ld	s4,32(sp)
    80005ec2:	6ae2                	ld	s5,24(sp)
    80005ec4:	6161                	addi	sp,sp,80
    80005ec6:	8082                	ret
  kfree(m);
    80005ec8:	8526                	mv	a0,s1
    80005eca:	ffffa097          	auipc	ra,0xffffa
    80005ece:	152080e7          	jalr	338(ra) # 8000001c <kfree>
}
    80005ed2:	b7d5                	j	80005eb6 <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005ed4:	45d1                	li	a1,20
    80005ed6:	8526                	mv	a0,s1
    80005ed8:	00000097          	auipc	ra,0x0
    80005edc:	c8e080e7          	jalr	-882(ra) # 80005b66 <mbufpull>
    80005ee0:	892a                	mv	s2,a0
  if (!iphdr)
    80005ee2:	c519                	beqz	a0,80005ef0 <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005ee4:	00054703          	lbu	a4,0(a0)
    80005ee8:	04500793          	li	a5,69
    80005eec:	00f70863          	beq	a4,a5,80005efc <net_rx+0x9a>
  kfree(m);
    80005ef0:	8526                	mv	a0,s1
    80005ef2:	ffffa097          	auipc	ra,0xffffa
    80005ef6:	12a080e7          	jalr	298(ra) # 8000001c <kfree>
}
    80005efa:	bf75                	j	80005eb6 <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005efc:	45d1                	li	a1,20
    80005efe:	00000097          	auipc	ra,0x0
    80005f02:	bf4080e7          	jalr	-1036(ra) # 80005af2 <in_cksum>
    80005f06:	f56d                	bnez	a0,80005ef0 <net_rx+0x8e>
    80005f08:	00695783          	lhu	a5,6(s2)
    80005f0c:	0087d713          	srli	a4,a5,0x8
    80005f10:	0087979b          	slliw	a5,a5,0x8
    80005f14:	0ff77713          	andi	a4,a4,255
    80005f18:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005f1a:	17c2                	slli	a5,a5,0x30
    80005f1c:	93c1                	srli	a5,a5,0x30
    80005f1e:	fbe9                	bnez	a5,80005ef0 <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005f20:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005f24:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005f28:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005f2c:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005f2e:	0087169b          	slliw	a3,a4,0x8
    80005f32:	00ff0637          	lui	a2,0xff0
    80005f36:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005f38:	8fd5                	or	a5,a5,a3
    80005f3a:	0087571b          	srliw	a4,a4,0x8
    80005f3e:	66c1                	lui	a3,0x10
    80005f40:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f44:	8f75                	and	a4,a4,a3
    80005f46:	8fd9                	or	a5,a5,a4
    80005f48:	2781                	sext.w	a5,a5
    80005f4a:	0a000737          	lui	a4,0xa000
    80005f4e:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f52:	f8e79fe3          	bne	a5,a4,80005ef0 <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f56:	00994703          	lbu	a4,9(s2)
    80005f5a:	47c5                	li	a5,17
    80005f5c:	f8f71ae3          	bne	a4,a5,80005ef0 <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f60:	00295783          	lhu	a5,2(s2)
    80005f64:	0087d713          	srli	a4,a5,0x8
    80005f68:	0087999b          	slliw	s3,a5,0x8
    80005f6c:	0ff77793          	andi	a5,a4,255
    80005f70:	00f9e9b3          	or	s3,s3,a5
    80005f74:	19c2                	slli	s3,s3,0x30
    80005f76:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f7a:	fec9879b          	addiw	a5,s3,-20
    80005f7e:	03079a13          	slli	s4,a5,0x30
    80005f82:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f86:	45a1                	li	a1,8
    80005f88:	8526                	mv	a0,s1
    80005f8a:	00000097          	auipc	ra,0x0
    80005f8e:	bdc080e7          	jalr	-1060(ra) # 80005b66 <mbufpull>
    80005f92:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f94:	c915                	beqz	a0,80005fc8 <net_rx+0x166>
    80005f96:	00455783          	lhu	a5,4(a0)
    80005f9a:	0087d713          	srli	a4,a5,0x8
    80005f9e:	0087979b          	slliw	a5,a5,0x8
    80005fa2:	0ff77713          	andi	a4,a4,255
    80005fa6:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005fa8:	2a01                	sext.w	s4,s4
    80005faa:	17c2                	slli	a5,a5,0x30
    80005fac:	93c1                	srli	a5,a5,0x30
    80005fae:	00fa1d63          	bne	s4,a5,80005fc8 <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005fb2:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005fb6:	0107979b          	slliw	a5,a5,0x10
    80005fba:	0107d79b          	srliw	a5,a5,0x10
    80005fbe:	0007871b          	sext.w	a4,a5
    80005fc2:	488c                	lw	a1,16(s1)
    80005fc4:	00e5f863          	bgeu	a1,a4,80005fd4 <net_rx+0x172>
  kfree(m);
    80005fc8:	8526                	mv	a0,s1
    80005fca:	ffffa097          	auipc	ra,0xffffa
    80005fce:	052080e7          	jalr	82(ra) # 8000001c <kfree>
}
    80005fd2:	b5d5                	j	80005eb6 <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005fd4:	9d9d                	subw	a1,a1,a5
    80005fd6:	8526                	mv	a0,s1
    80005fd8:	00000097          	auipc	ra,0x0
    80005fdc:	c9c080e7          	jalr	-868(ra) # 80005c74 <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005fe0:	00c92783          	lw	a5,12(s2)
    80005fe4:	000ad703          	lhu	a4,0(s5)
    80005fe8:	00875693          	srli	a3,a4,0x8
    80005fec:	0087171b          	slliw	a4,a4,0x8
    80005ff0:	0ff6f693          	andi	a3,a3,255
    80005ff4:	8ed9                	or	a3,a3,a4
    80005ff6:	002ad703          	lhu	a4,2(s5)
    80005ffa:	00875613          	srli	a2,a4,0x8
    80005ffe:	0087171b          	slliw	a4,a4,0x8
    80006002:	0ff67613          	andi	a2,a2,255
    80006006:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80006008:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    8000600c:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006010:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80006012:	0087959b          	slliw	a1,a5,0x8
    80006016:	00ff0537          	lui	a0,0xff0
    8000601a:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    8000601c:	8f4d                	or	a4,a4,a1
    8000601e:	0087d79b          	srliw	a5,a5,0x8
    80006022:	65c1                	lui	a1,0x10
    80006024:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80006028:	8fed                	and	a5,a5,a1
    8000602a:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    8000602c:	16c2                	slli	a3,a3,0x30
    8000602e:	92c1                	srli	a3,a3,0x30
    80006030:	1642                	slli	a2,a2,0x30
    80006032:	9241                	srli	a2,a2,0x30
    80006034:	0007859b          	sext.w	a1,a5
    80006038:	8526                	mv	a0,s1
    8000603a:	00000097          	auipc	ra,0x0
    8000603e:	55c080e7          	jalr	1372(ra) # 80006596 <sockrecvudp>
  return;
    80006042:	bd95                	j	80005eb6 <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    80006044:	45f1                	li	a1,28
    80006046:	8526                	mv	a0,s1
    80006048:	00000097          	auipc	ra,0x0
    8000604c:	b1e080e7          	jalr	-1250(ra) # 80005b66 <mbufpull>
    80006050:	892a                	mv	s2,a0
  if (!arphdr)
    80006052:	c179                	beqz	a0,80006118 <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006054:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006058:	00154703          	lbu	a4,1(a0)
    8000605c:	0722                	slli	a4,a4,0x8
    8000605e:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    80006060:	0087979b          	slliw	a5,a5,0x8
    80006064:	8321                	srli	a4,a4,0x8
    80006066:	8fd9                	or	a5,a5,a4
    80006068:	17c2                	slli	a5,a5,0x30
    8000606a:	93c1                	srli	a5,a5,0x30
    8000606c:	4705                	li	a4,1
    8000606e:	0ae79563          	bne	a5,a4,80006118 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006072:	00254783          	lbu	a5,2(a0)
    80006076:	00354703          	lbu	a4,3(a0)
    8000607a:	0722                	slli	a4,a4,0x8
    8000607c:	8fd9                	or	a5,a5,a4
    8000607e:	0087979b          	slliw	a5,a5,0x8
    80006082:	8321                	srli	a4,a4,0x8
    80006084:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006086:	0107979b          	slliw	a5,a5,0x10
    8000608a:	0107d79b          	srliw	a5,a5,0x10
    8000608e:	8007879b          	addiw	a5,a5,-2048
    80006092:	e3d9                	bnez	a5,80006118 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006094:	00454703          	lbu	a4,4(a0)
    80006098:	4799                	li	a5,6
    8000609a:	06f71f63          	bne	a4,a5,80006118 <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    8000609e:	00554703          	lbu	a4,5(a0)
    800060a2:	4791                	li	a5,4
    800060a4:	06f71a63          	bne	a4,a5,80006118 <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060a8:	00654783          	lbu	a5,6(a0)
    800060ac:	00754703          	lbu	a4,7(a0)
    800060b0:	0722                	slli	a4,a4,0x8
    800060b2:	8fd9                	or	a5,a5,a4
    800060b4:	0087979b          	slliw	a5,a5,0x8
    800060b8:	8321                	srli	a4,a4,0x8
    800060ba:	8fd9                	or	a5,a5,a4
    800060bc:	17c2                	slli	a5,a5,0x30
    800060be:	93c1                	srli	a5,a5,0x30
    800060c0:	4705                	li	a4,1
    800060c2:	04e79b63          	bne	a5,a4,80006118 <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    800060c6:	01854783          	lbu	a5,24(a0)
    800060ca:	01954703          	lbu	a4,25(a0)
    800060ce:	0722                	slli	a4,a4,0x8
    800060d0:	8f5d                	or	a4,a4,a5
    800060d2:	01a54783          	lbu	a5,26(a0)
    800060d6:	07c2                	slli	a5,a5,0x10
    800060d8:	8f5d                	or	a4,a4,a5
    800060da:	01b54783          	lbu	a5,27(a0)
    800060de:	07e2                	slli	a5,a5,0x18
    800060e0:	8fd9                	or	a5,a5,a4
    800060e2:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060e6:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    800060ea:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800060ee:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    800060f0:	0087169b          	slliw	a3,a4,0x8
    800060f4:	00ff0637          	lui	a2,0xff0
    800060f8:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    800060fa:	8fd5                	or	a5,a5,a3
    800060fc:	0087571b          	srliw	a4,a4,0x8
    80006100:	66c1                	lui	a3,0x10
    80006102:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006106:	8f75                	and	a4,a4,a3
    80006108:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    8000610a:	2781                	sext.w	a5,a5
    8000610c:	0a000737          	lui	a4,0xa000
    80006110:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80006114:	00e78863          	beq	a5,a4,80006124 <net_rx+0x2c2>
  kfree(m);
    80006118:	8526                	mv	a0,s1
    8000611a:	ffffa097          	auipc	ra,0xffffa
    8000611e:	f02080e7          	jalr	-254(ra) # 8000001c <kfree>
}
    80006122:	bb51                	j	80005eb6 <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    80006124:	4619                	li	a2,6
    80006126:	00850593          	addi	a1,a0,8
    8000612a:	fb840513          	addi	a0,s0,-72
    8000612e:	ffffa097          	auipc	ra,0xffffa
    80006132:	0aa080e7          	jalr	170(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    80006136:	00e94783          	lbu	a5,14(s2)
    8000613a:	00f94703          	lbu	a4,15(s2)
    8000613e:	0722                	slli	a4,a4,0x8
    80006140:	8f5d                	or	a4,a4,a5
    80006142:	01094783          	lbu	a5,16(s2)
    80006146:	07c2                	slli	a5,a5,0x10
    80006148:	8f5d                	or	a4,a4,a5
    8000614a:	01194783          	lbu	a5,17(s2)
    8000614e:	07e2                	slli	a5,a5,0x18
    80006150:	8fd9                	or	a5,a5,a4
    80006152:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006156:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    8000615a:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000615e:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    80006162:	0087179b          	slliw	a5,a4,0x8
    80006166:	00ff06b7          	lui	a3,0xff0
    8000616a:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    8000616c:	00f96933          	or	s2,s2,a5
    80006170:	0087579b          	srliw	a5,a4,0x8
    80006174:	6741                	lui	a4,0x10
    80006176:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    8000617a:	8ff9                	and	a5,a5,a4
    8000617c:	00f96933          	or	s2,s2,a5
    80006180:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006182:	08000513          	li	a0,128
    80006186:	00000097          	auipc	ra,0x0
    8000618a:	b10080e7          	jalr	-1264(ra) # 80005c96 <mbufalloc>
    8000618e:	8a2a                	mv	s4,a0
  if (!m)
    80006190:	d541                	beqz	a0,80006118 <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    80006192:	45f1                	li	a1,28
    80006194:	00000097          	auipc	ra,0x0
    80006198:	aa6080e7          	jalr	-1370(ra) # 80005c3a <mbufput>
    8000619c:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    8000619e:	00050023          	sb	zero,0(a0)
    800061a2:	4785                	li	a5,1
    800061a4:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    800061a8:	47a1                	li	a5,8
    800061aa:	00f50123          	sb	a5,2(a0)
    800061ae:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    800061b2:	4799                	li	a5,6
    800061b4:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    800061b8:	4791                	li	a5,4
    800061ba:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    800061be:	00050323          	sb	zero,6(a0)
    800061c2:	4a89                	li	s5,2
    800061c4:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    800061c8:	4619                	li	a2,6
    800061ca:	00003597          	auipc	a1,0x3
    800061ce:	6f658593          	addi	a1,a1,1782 # 800098c0 <local_mac>
    800061d2:	0521                	addi	a0,a0,8
    800061d4:	ffffa097          	auipc	ra,0xffffa
    800061d8:	004080e7          	jalr	4(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    800061dc:	47a9                	li	a5,10
    800061de:	00f98723          	sb	a5,14(s3)
    800061e2:	000987a3          	sb	zero,15(s3)
    800061e6:	01598823          	sb	s5,16(s3)
    800061ea:	47bd                	li	a5,15
    800061ec:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    800061f0:	4619                	li	a2,6
    800061f2:	fb840593          	addi	a1,s0,-72
    800061f6:	01298513          	addi	a0,s3,18
    800061fa:	ffffa097          	auipc	ra,0xffffa
    800061fe:	fde080e7          	jalr	-34(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    80006202:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    80006206:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000620a:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    8000620c:	0089179b          	slliw	a5,s2,0x8
    80006210:	00ff06b7          	lui	a3,0xff0
    80006214:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006216:	8f5d                	or	a4,a4,a5
    80006218:	0089579b          	srliw	a5,s2,0x8
    8000621c:	66c1                	lui	a3,0x10
    8000621e:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006222:	8ff5                	and	a5,a5,a3
    80006224:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    80006226:	00e98c23          	sb	a4,24(s3)
    8000622a:	0087d71b          	srliw	a4,a5,0x8
    8000622e:	00e98ca3          	sb	a4,25(s3)
    80006232:	0107d71b          	srliw	a4,a5,0x10
    80006236:	00e98d23          	sb	a4,26(s3)
    8000623a:	0187d79b          	srliw	a5,a5,0x18
    8000623e:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    80006242:	6585                	lui	a1,0x1
    80006244:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    80006248:	8552                	mv	a0,s4
    8000624a:	00000097          	auipc	ra,0x0
    8000624e:	978080e7          	jalr	-1672(ra) # 80005bc2 <net_tx_eth>
  return 0;
    80006252:	b5d9                	j	80006118 <net_rx+0x2b6>

0000000080006254 <sockinit>:
...
sockinit(void)
{
  ...
  initlock(&lock, "socktbl");
    8000625c:	00003597          	auipc	a1,0x3
    80006260:	5c458593          	addi	a1,a1,1476 # 80009820 <syscalls+0x448>
    80006264:	00019517          	auipc	a0,0x19
    80006268:	0bc50513          	addi	a0,a0,188 # 8001f320 <lock>
    8000626c:	00001097          	auipc	ra,0x1
    80006270:	e5c080e7          	jalr	-420(ra) # 800070c8 <initlock>
}
...
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    80006284:	f04a                	sd	s2,32(sp)
    80006286:	ec4e                	sd	s3,24(sp)
    80006288:	e852                	sd	s4,16(sp)
    8000628a:	e456                	sd	s5,8(sp)
    8000628c:	0080                	addi	s0,sp,64
    8000628e:	892a                	mv	s2,a0
    80006290:	84ae                	mv	s1,a1
    80006292:	8a32                	mv	s4,a2
    80006294:	89b6                	mv	s3,a3
  struct sock *si, *pos;
  ...
  *f = 0;
  ...
  if ((*f = filealloc()) == 0)
    ...
    8000629e:	636080e7          	jalr	1590(ra) # 800038d0 <filealloc>
    800062a2:	00a93023          	sd	a0,0(s2)
    800062a6:	c975                	beqz	a0,8000639a <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    800062a8:	ffffa097          	auipc	ra,0xffffa
    800062ac:	e70080e7          	jalr	-400(ra) # 80000118 <kalloc>
    800062b0:	8aaa                	mv	s5,a0
    800062b2:	c15d                	beqz	a0,80006358 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    800062b4:	c504                	sw	s1,8(a0)
  si->lport = lport;
    800062b6:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    800062ba:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    800062be:	00003597          	auipc	a1,0x3
    800062c2:	56a58593          	addi	a1,a1,1386 # 80009828 <syscalls+0x450>
    800062c6:	0541                	addi	a0,a0,16
    800062c8:	00001097          	auipc	ra,0x1
    800062cc:	e00080e7          	jalr	-512(ra) # 800070c8 <initlock>
  mbufq_init(&si->rxq);
    800062d0:	028a8513          	addi	a0,s5,40
    800062d4:	00000097          	auipc	ra,0x0
    800062d8:	a7a080e7          	jalr	-1414(ra) # 80005d4e <mbufq_init>
  (*f)->type = FD_SOCK;
    800062dc:	00093783          	ld	a5,0(s2)
    800062e0:	4711                	li	a4,4
    800062e2:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062e4:	00093703          	ld	a4,0(s2)
    800062e8:	4785                	li	a5,1
    800062ea:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    800062ee:	00093703          	ld	a4,0(s2)
    800062f2:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    800062f6:	00093783          	ld	a5,0(s2)
    800062fa:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>

  // add to list of sockets
  acquire(&lock);
    800062fe:	00019517          	auipc	a0,0x19
    80006302:	02250513          	addi	a0,a0,34 # 8001f320 <lock>
    80006306:	00001097          	auipc	ra,0x1
    8000630a:	e52080e7          	jalr	-430(ra) # 80007158 <acquire>
  pos = sockets;
    8000630e:	00004597          	auipc	a1,0x4
    80006312:	d1a5b583          	ld	a1,-742(a1) # 8000a028 <sockets>
  while (pos) {
    80006316:	c9b1                	beqz	a1,8000636a <sockalloc+0xee>
  pos = sockets;
    80006318:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    8000631a:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    8000631e:	0009869b          	sext.w	a3,s3
    80006322:	a019                	j	80006328 <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
  ...
  while (pos) {
    80006326:	c3b1                	beqz	a5,8000636a <sockalloc+0xee>
    if (pos->raddr == raddr &&
    80006328:	4798                	lw	a4,8(a5)
    8000632a:	fe971de3          	bne	a4,s1,80006324 <sockalloc+0xa8>
    8000632e:	00c7d703          	lhu	a4,12(a5)
    80006332:	fec719e3          	bne	a4,a2,80006324 <sockalloc+0xa8>
        pos->lport == lport &&
    80006336:	00e7d703          	lhu	a4,14(a5)
    8000633a:	fed715e3          	bne	a4,a3,80006324 <sockalloc+0xa8>
      release(&lock);
    8000633e:	00019517          	auipc	a0,0x19
    80006342:	fe250513          	addi	a0,a0,-30 # 8001f320 <lock>
    80006346:	00001097          	auipc	ra,0x1
    8000634a:	ec6080e7          	jalr	-314(ra) # 8000720c <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    ...
    80006354:	ccc080e7          	jalr	-820(ra) # 8000001c <kfree>
  if (*f)
    80006358:	00093503          	ld	a0,0(s2)
    8000635c:	c129                	beqz	a0,8000639e <sockalloc+0x122>
    fileclose(*f);
    8000635e:	ffffd097          	auipc	ra,0xffffd
    80006362:	62e080e7          	jalr	1582(ra) # 8000398c <fileclose>
  return -1;
    80006366:	557d                	li	a0,-1
    80006368:	a005                	j	80006388 <sockalloc+0x10c>
  si->next = sockets;
    8000636a:	00bab023          	sd	a1,0(s5)
  sockets = si;
    8000636e:	00004797          	auipc	a5,0x4
    80006372:	cb57bd23          	sd	s5,-838(a5) # 8000a028 <sockets>
  release(&lock);
    80006376:	00019517          	auipc	a0,0x19
    8000637a:	faa50513          	addi	a0,a0,-86 # 8001f320 <lock>
    8000637e:	00001097          	auipc	ra,0x1
    80006382:	e8e080e7          	jalr	-370(ra) # 8000720c <release>
  return 0;
  ...
  return -1;
    ...
    8000639c:	b7f5                	j	80006388 <sockalloc+0x10c>
    8000639e:	557d                	li	a0,-1
    800063a0:	b7e5                	j	80006388 <sockalloc+0x10c>

00000000800063a2 <sockclose>:
...
sockclose(struct sock *si)
{
    ...
    800063aa:	e04a                	sd	s2,0(sp)
    800063ac:	1000                	addi	s0,sp,32
    800063ae:	892a                	mv	s2,a0
  struct sock **pos;
  struct mbuf *m;

  // remove from list of sockets
  acquire(&lock);
    800063b0:	00019517          	auipc	a0,0x19
    800063b4:	f7050513          	addi	a0,a0,-144 # 8001f320 <lock>
    800063b8:	00001097          	auipc	ra,0x1
    800063bc:	da0080e7          	jalr	-608(ra) # 80007158 <acquire>
  pos = &sockets;
    800063c0:	00004797          	auipc	a5,0x4
    800063c4:	c687b783          	ld	a5,-920(a5) # 8000a028 <sockets>
  while (*pos) {
    800063c8:	cb99                	beqz	a5,800063de <sockclose+0x3c>
    if (*pos == si){
    800063ca:	02f90563          	beq	s2,a5,800063f4 <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    800063ce:	873e                	mv	a4,a5
    800063d0:	639c                	ld	a5,0(a5)
  while (*pos) {
    800063d2:	c791                	beqz	a5,800063de <sockclose+0x3c>
    if (*pos == si){
    800063d4:	fef91de3          	bne	s2,a5,800063ce <sockclose+0x2c>
      *pos = si->next;
    800063d8:	00093783          	ld	a5,0(s2)
    800063dc:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    800063de:	00019517          	auipc	a0,0x19
    800063e2:	f4250513          	addi	a0,a0,-190 # 8001f320 <lock>
    800063e6:	00001097          	auipc	ra,0x1
    800063ea:	e26080e7          	jalr	-474(ra) # 8000720c <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    800063ee:	02890493          	addi	s1,s2,40
    800063f2:	a839                	j	80006410 <sockclose+0x6e>
  pos = &sockets;
    800063f4:	00004717          	auipc	a4,0x4
    800063f8:	c3470713          	addi	a4,a4,-972 # 8000a028 <sockets>
    800063fc:	bff1                	j	800063d8 <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    800063fe:	8526                	mv	a0,s1
    80006400:	00000097          	auipc	ra,0x0
    80006404:	926080e7          	jalr	-1754(ra) # 80005d26 <mbufq_pophead>
    mbuffree(m);
    80006408:	00000097          	auipc	ra,0x0
    8000640c:	8e6080e7          	jalr	-1818(ra) # 80005cee <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    80006410:	8526                	mv	a0,s1
    80006412:	00000097          	auipc	ra,0x0
    80006416:	92a080e7          	jalr	-1750(ra) # 80005d3c <mbufq_empty>
    8000641a:	d175                	beqz	a0,800063fe <sockclose+0x5c>
  }

  kfree((char*)si);
    8000641c:	854a                	mv	a0,s2
    8000641e:	ffffa097          	auipc	ra,0xffffa
    80006422:	bfe080e7          	jalr	-1026(ra) # 8000001c <kfree>
}
...
0000000080006432 <sockread>:

int
sockread(struct sock *si, uint64 addr, int n)
{
    80006432:	7139                	addi	sp,sp,-64
    80006434:	fc06                	sd	ra,56(sp)
    80006436:	f822                	sd	s0,48(sp)
    80006438:	f426                	sd	s1,40(sp)
    8000643a:	f04a                	sd	s2,32(sp)
    8000643c:	ec4e                	sd	s3,24(sp)
    8000643e:	e852                	sd	s4,16(sp)
    80006440:	e456                	sd	s5,8(sp)
    80006442:	0080                	addi	s0,sp,64
    80006444:	84aa                	mv	s1,a0
    80006446:	8a2e                	mv	s4,a1
    80006448:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    8000644a:	ffffb097          	auipc	ra,0xffffb
    8000644e:	a56080e7          	jalr	-1450(ra) # 80000ea0 <myproc>
    80006452:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    80006454:	01048993          	addi	s3,s1,16
    80006458:	854e                	mv	a0,s3
    8000645a:	00001097          	auipc	ra,0x1
    8000645e:	cfe080e7          	jalr	-770(ra) # 80007158 <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    80006462:	02848493          	addi	s1,s1,40
    80006466:	8526                	mv	a0,s1
    80006468:	00000097          	auipc	ra,0x0
    8000646c:	8d4080e7          	jalr	-1836(ra) # 80005d3c <mbufq_empty>
    80006470:	c919                	beqz	a0,80006486 <sockread+0x54>
    80006472:	02892783          	lw	a5,40(s2)
    80006476:	eba5                	bnez	a5,800064e6 <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    80006478:	85ce                	mv	a1,s3
    8000647a:	8526                	mv	a0,s1
    8000647c:	ffffb097          	auipc	ra,0xffffb
    80006480:	0e0080e7          	jalr	224(ra) # 8000155c <sleep>
    80006484:	b7cd                	j	80006466 <sockread+0x34>
  }
  if (pr->killed) {
    80006486:	02892783          	lw	a5,40(s2)
    8000648a:	efb1                	bnez	a5,800064e6 <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    80006492:	898080e7          	jalr	-1896(ra) # 80005d26 <mbufq_pophead>
    80006496:	84aa                	mv	s1,a0
  release(&si->lock);
    80006498:	854e                	mv	a0,s3
    8000649a:	00001097          	auipc	ra,0x1
    8000649e:	d72080e7          	jalr	-654(ra) # 8000720c <release>

  len = m->len;
    800064a2:	489c                	lw	a5,16(s1)
  if (len > n)
    800064a4:	89be                	mv	s3,a5
    800064a6:	00fad363          	bge	s5,a5,800064ac <sockread+0x7a>
    800064aa:	89d6                	mv	s3,s5
    800064ac:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    800064ae:	86ce                	mv	a3,s3
    800064b0:	6490                	ld	a2,8(s1)
    800064b2:	85d2                	mv	a1,s4
    800064b4:	05093503          	ld	a0,80(s2)
    800064b8:	ffffa097          	auipc	ra,0xffffa
    800064bc:	6ae080e7          	jalr	1710(ra) # 80000b66 <copyout>
    800064c0:	892a                	mv	s2,a0
    800064c2:	57fd                	li	a5,-1
    800064c4:	02f50863          	beq	a0,a5,800064f4 <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    800064ce:	824080e7          	jalr	-2012(ra) # 80005cee <mbuffree>
  return len;
}
    800064d2:	854e                	mv	a0,s3
    800064d4:	70e2                	ld	ra,56(sp)
    800064d6:	7442                	ld	s0,48(sp)
    800064d8:	74a2                	ld	s1,40(sp)
    800064da:	7902                	ld	s2,32(sp)
    800064dc:	69e2                	ld	s3,24(sp)
    800064de:	6a42                	ld	s4,16(sp)
    800064e0:	6aa2                	ld	s5,8(sp)
    800064e2:	6121                	addi	sp,sp,64
    800064e4:	8082                	ret
    release(&si->lock);
    800064e6:	854e                	mv	a0,s3
    800064e8:	00001097          	auipc	ra,0x1
    800064ec:	d24080e7          	jalr	-732(ra) # 8000720c <release>
    return -1;
    800064f0:	59fd                	li	s3,-1
    800064f2:	b7c5                	j	800064d2 <sockread+0xa0>
    mbuffree(m);
    800064f4:	8526                	mv	a0,s1
    800064f6:	fffff097          	auipc	ra,0xfffff
    800064fa:	7f8080e7          	jalr	2040(ra) # 80005cee <mbuffree>
    return -1;
    800064fe:	89ca                	mv	s3,s2
    80006500:	bfc9                	j	800064d2 <sockread+0xa0>

0000000080006502 <sockwrite>:
...
sockwrite(struct sock *si, uint64 addr, int n)
{
    ...
    80006518:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    8000651a:	ffffb097          	auipc	ra,0xffffb
    8000651e:	986080e7          	jalr	-1658(ra) # 80000ea0 <myproc>
    80006522:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006524:	08000513          	li	a0,128
    80006528:	fffff097          	auipc	ra,0xfffff
    8000652c:	76e080e7          	jalr	1902(ra) # 80005c96 <mbufalloc>
  if (!m)
    80006530:	c12d                	beqz	a0,80006592 <sockwrite+0x90>
    80006532:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    80006534:	050a3a03          	ld	s4,80(s4)
    80006538:	85ca                	mv	a1,s2
    8000653a:	fffff097          	auipc	ra,0xfffff
    8000653e:	700080e7          	jalr	1792(ra) # 80005c3a <mbufput>
    80006542:	85aa                	mv	a1,a0
    80006544:	86ca                	mv	a3,s2
    80006546:	864e                	mv	a2,s3
    80006548:	8552                	mv	a0,s4
    8000654a:	ffffa097          	auipc	ra,0xffffa
    8000654e:	6a8080e7          	jalr	1704(ra) # 80000bf2 <copyin>
    80006552:	89aa                	mv	s3,a0
    80006554:	57fd                	li	a5,-1
    80006556:	02f50863          	beq	a0,a5,80006586 <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    8000655a:	00ead683          	lhu	a3,14(s5)
    8000655e:	00cad603          	lhu	a2,12(s5)
    80006562:	008aa583          	lw	a1,8(s5)
    80006566:	8526                	mv	a0,s1
    80006568:	fffff097          	auipc	ra,0xfffff
    8000656c:	7f6080e7          	jalr	2038(ra) # 80005d5e <net_tx_udp>
  return n;
    80006570:	89ca                	mv	s3,s2
}
    80006572:	854e                	mv	a0,s3
    80006574:	70e2                	ld	ra,56(sp)
    80006576:	7442                	ld	s0,48(sp)
    80006578:	74a2                	ld	s1,40(sp)
    8000657a:	7902                	ld	s2,32(sp)
    8000657c:	69e2                	ld	s3,24(sp)
    8000657e:	6a42                	ld	s4,16(sp)
    80006580:	6aa2                	ld	s5,8(sp)
    80006582:	6121                	addi	sp,sp,64
    80006584:	8082                	ret
    mbuffree(m);
    80006586:	8526                	mv	a0,s1
    80006588:	fffff097          	auipc	ra,0xfffff
    8000658c:	766080e7          	jalr	1894(ra) # 80005cee <mbuffree>
    return -1;
    80006590:	b7cd                	j	80006572 <sockwrite+0x70>
    return -1;
    80006592:	59fd                	li	s3,-1
    80006594:	bff9                	j	80006572 <sockwrite+0x70>

0000000080006596 <sockrecvudp>:
...
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    8000659e:	f04a                	sd	s2,32(sp)
    800065a0:	ec4e                	sd	s3,24(sp)
    800065a2:	e852                	sd	s4,16(sp)
    800065a4:	e456                	sd	s5,8(sp)
    800065a6:	0080                	addi	s0,sp,64
    800065a8:	8a2a                	mv	s4,a0
    800065aa:	892e                	mv	s2,a1
    800065ac:	89b2                	mv	s3,a2
    800065ae:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    800065b0:	00019517          	auipc	a0,0x19
    800065b4:	d7050513          	addi	a0,a0,-656 # 8001f320 <lock>
    800065b8:	00001097          	auipc	ra,0x1
    800065bc:	ba0080e7          	jalr	-1120(ra) # 80007158 <acquire>
  si = sockets;
    800065c0:	00004497          	auipc	s1,0x4
    800065c4:	a684b483          	ld	s1,-1432(s1) # 8000a028 <sockets>
  while (si) {
    800065c8:	c4ad                	beqz	s1,80006632 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065ca:	0009871b          	sext.w	a4,s3
    800065ce:	000a869b          	sext.w	a3,s5
    800065d2:	a019                	j	800065d8 <sockrecvudp+0x42>
      goto found;
    si = si->next;
    800065d4:	6084                	ld	s1,0(s1)
  while (si) {
    800065d6:	ccb1                	beqz	s1,80006632 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065d8:	449c                	lw	a5,8(s1)
    800065da:	ff279de3          	bne	a5,s2,800065d4 <sockrecvudp+0x3e>
    800065de:	00c4d783          	lhu	a5,12(s1)
    800065e2:	fee799e3          	bne	a5,a4,800065d4 <sockrecvudp+0x3e>
    800065e6:	00e4d783          	lhu	a5,14(s1)
    800065ea:	fed795e3          	bne	a5,a3,800065d4 <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    800065ee:	01048913          	addi	s2,s1,16
    800065f2:	854a                	mv	a0,s2
    800065f4:	00001097          	auipc	ra,0x1
    800065f8:	b64080e7          	jalr	-1180(ra) # 80007158 <acquire>
  mbufq_pushtail(&si->rxq, m);
    800065fc:	02848493          	addi	s1,s1,40
    80006600:	85d2                	mv	a1,s4
    80006602:	8526                	mv	a0,s1
    80006604:	fffff097          	auipc	ra,0xfffff
    80006608:	702080e7          	jalr	1794(ra) # 80005d06 <mbufq_pushtail>
  wakeup(&si->rxq);
    8000660c:	8526                	mv	a0,s1
    8000660e:	ffffb097          	auipc	ra,0xffffb
    80006612:	0da080e7          	jalr	218(ra) # 800016e8 <wakeup>
  release(&si->lock);
    80006616:	854a                	mv	a0,s2
    80006618:	00001097          	auipc	ra,0x1
    8000661c:	bf4080e7          	jalr	-1036(ra) # 8000720c <release>
  release(&lock);
    80006620:	00019517          	auipc	a0,0x19
    80006624:	d0050513          	addi	a0,a0,-768 # 8001f320 <lock>
    80006628:	00001097          	auipc	ra,0x1
    8000662c:	be4080e7          	jalr	-1052(ra) # 8000720c <release>
    80006630:	a831                	j	8000664c <sockrecvudp+0xb6>
  release(&lock);
    80006632:	00019517          	auipc	a0,0x19
    80006636:	cee50513          	addi	a0,a0,-786 # 8001f320 <lock>
    8000663a:	00001097          	auipc	ra,0x1
    8000663e:	bd2080e7          	jalr	-1070(ra) # 8000720c <release>
  mbuffree(m);
    80006642:	8552                	mv	a0,s4
    80006644:	fffff097          	auipc	ra,0xfffff
    80006648:	6aa080e7          	jalr	1706(ra) # 80005cee <mbuffree>
}
    8000664c:	70e2                	ld	ra,56(sp)
    8000664e:	7442                	ld	s0,48(sp)
    80006650:	74a2                	ld	s1,40(sp)
    80006652:	7902                	ld	s2,32(sp)
    80006654:	69e2                	ld	s3,24(sp)
    80006656:	6a42                	ld	s4,16(sp)
    80006658:	6aa2                	ld	s5,8(sp)
    8000665a:	6121                	addi	sp,sp,64
    8000665c:	8082                	ret

000000008000665e <pci_init>:
#include "proc.h"
#include "defs.h"
...
pci_init()
{
    8000665e:	715d                	addi	sp,sp,-80
    80006660:	e486                	sd	ra,72(sp)
    80006662:	e0a2                	sd	s0,64(sp)
    80006664:	fc26                	sd	s1,56(sp)
    80006666:	f84a                	sd	s2,48(sp)
    80006668:	f44e                	sd	s3,40(sp)
    8000666a:	f052                	sd	s4,32(sp)
    8000666c:	ec56                	sd	s5,24(sp)
    8000666e:	e85a                	sd	s6,16(sp)
    80006670:	e45e                	sd	s7,8(sp)
    80006672:	0880                	addi	s0,sp,80
    80006674:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    80006678:	100e8937          	lui	s2,0x100e8
    8000667c:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    80006680:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    80006682:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    80006684:	40000b37          	lui	s6,0x40000
    80006688:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    8000668a:	300409b7          	lui	s3,0x30040
    8000668e:	a821                	j	800066a6 <pci_init+0x48>
      base[4+0] = e1000_regs;
    80006690:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    80006694:	40000537          	lui	a0,0x40000
    80006698:	fffff097          	auipc	ra,0xfffff
    8000669c:	0c8080e7          	jalr	200(ra) # 80005760 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    800066a0:	94d2                	add	s1,s1,s4
    800066a2:	03348a63          	beq	s1,s3,800066d6 <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    800066a6:	86a6                	mv	a3,s1
    uint32 id = base[0];
    800066a8:	409c                	lw	a5,0(s1)
    800066aa:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    800066ac:	ff279ae3          	bne	a5,s2,800066a0 <pci_init+0x42>
      base[1] = 7;
    800066b0:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    800066b4:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    800066b8:	01048793          	addi	a5,s1,16
    800066bc:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    800066c0:	4398                	lw	a4,0(a5)
    800066c2:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    800066c4:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    800066c8:	0ff0000f          	fence
        base[4+i] = old;
    800066cc:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    800066ce:	0791                	addi	a5,a5,4
    800066d0:	fec798e3          	bne	a5,a2,800066c0 <pci_init+0x62>
    800066d4:	bf75                	j	80006690 <pci_init+0x32>
    }
  }
}
    800066d6:	60a6                	ld	ra,72(sp)
    800066d8:	6406                	ld	s0,64(sp)
    800066da:	74e2                	ld	s1,56(sp)
    800066dc:	7942                	ld	s2,48(sp)
    800066de:	79a2                	ld	s3,40(sp)
    800066e0:	7a02                	ld	s4,32(sp)
    800066e2:	6ae2                	ld	s5,24(sp)
    800066e4:	6b42                	ld	s6,16(sp)
    800066e6:	6ba2                	ld	s7,8(sp)
    800066e8:	6161                	addi	sp,sp,80
    800066ea:	8082                	ret

00000000800066ec <timerinit>:
...
timerinit()
{
  ...
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800066f2:	f14027f3          	csrr	a5,mhartid
  // each CPU has a separate source of timer interrupts.
  int id = r_mhartid();
    800066f6:	0007869b          	sext.w	a3,a5

  // ask the CLINT for a timer interrupt.
  int interval = 1000000; // cycles; about 1/10th second in qemu.
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    800066fa:	0037979b          	slliw	a5,a5,0x3
    800066fe:	02004737          	lui	a4,0x2004
    80006702:	97ba                	add	a5,a5,a4
    80006704:	0200c737          	lui	a4,0x200c
    80006708:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    8000670c:	000f4637          	lui	a2,0xf4
    80006710:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    80006714:	95b2                	add	a1,a1,a2
    80006716:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    80006718:	00269713          	slli	a4,a3,0x2
    8000671c:	9736                	add	a4,a4,a3
    8000671e:	00371693          	slli	a3,a4,0x3
    80006722:	00019717          	auipc	a4,0x19
    80006726:	c1e70713          	addi	a4,a4,-994 # 8001f340 <timer_scratch>
    8000672a:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    8000672c:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    8000672e:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    80006730:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    80006734:	fffff797          	auipc	a5,0xfffff
    80006738:	9cc78793          	addi	a5,a5,-1588 # 80005100 <timervec>
  ...
  asm volatile("csrw mie, %0" : : "r" (x));
    ...
    80006758:	6422                	ld	s0,8(sp)
    8000675a:	0141                	addi	sp,sp,16
    8000675c:	8082                	ret

000000008000675e <start>:
{
    8000675e:	1141                	addi	sp,sp,-16
    80006760:	e406                	sd	ra,8(sp)
    80006762:	e022                	sd	s0,0(sp)
    80006764:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006766:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    8000676a:	7779                	lui	a4,0xffffe
    8000676c:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    80006770:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    80006772:	6705                	lui	a4,0x1
    80006774:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    80006778:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    8000677a:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    8000677e:	ffffa797          	auipc	a5,0xffffa
    80006782:	ba878793          	addi	a5,a5,-1112 # 80000326 <main>
    80006786:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    8000678a:	4781                	li	a5,0
    8000678c:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    80006790:	67c1                	lui	a5,0x10
    80006792:	17fd                	addi	a5,a5,-1
    80006794:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    80006798:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    8000679c:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    800067a0:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    800067a4:	10479073          	csrw	sie,a5
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    800067a8:	57fd                	li	a5,-1
    800067aa:	83a9                	srli	a5,a5,0xa
    800067ac:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    800067b0:	47bd                	li	a5,15
    800067b2:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    800067b6:	00000097          	auipc	ra,0x0
    800067ba:	f36080e7          	jalr	-202(ra) # 800066ec <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800067be:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    800067c2:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    800067c4:	823e                	mv	tp,a5
  asm volatile("mret");
    800067c6:	30200073          	mret
}
...
{
    800067d2:	715d                	addi	sp,sp,-80
    800067d4:	e486                	sd	ra,72(sp)
    800067d6:	e0a2                	sd	s0,64(sp)
    800067d8:	fc26                	sd	s1,56(sp)
    800067da:	f84a                	sd	s2,48(sp)
    800067dc:	f44e                	sd	s3,40(sp)
    800067de:	f052                	sd	s4,32(sp)
    800067e0:	ec56                	sd	s5,24(sp)
    800067e2:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    800067e4:	04c05663          	blez	a2,80006830 <consolewrite+0x5e>
    800067e8:	8a2a                	mv	s4,a0
    800067ea:	84ae                	mv	s1,a1
    800067ec:	89b2                	mv	s3,a2
    800067ee:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    800067f0:	5afd                	li	s5,-1
    800067f2:	4685                	li	a3,1
    800067f4:	8626                	mv	a2,s1
    800067f6:	85d2                	mv	a1,s4
    800067f8:	fbf40513          	addi	a0,s0,-65
    800067fc:	ffffb097          	auipc	ra,0xffffb
    80006800:	15a080e7          	jalr	346(ra) # 80001956 <either_copyin>
    80006804:	01550c63          	beq	a0,s5,8000681c <consolewrite+0x4a>
      break;
    uartputc(c);
    80006808:	fbf44503          	lbu	a0,-65(s0)
    8000680c:	00000097          	auipc	ra,0x0
    80006810:	78e080e7          	jalr	1934(ra) # 80006f9a <uartputc>
  for(i = 0; i < n; i++){
    80006814:	2905                	addiw	s2,s2,1
    80006816:	0485                	addi	s1,s1,1
    80006818:	fd299de3          	bne	s3,s2,800067f2 <consolewrite+0x20>
  }

  return i;
}
    8000681c:	854a                	mv	a0,s2
    8000681e:	60a6                	ld	ra,72(sp)
    80006820:	6406                	ld	s0,64(sp)
    80006822:	74e2                	ld	s1,56(sp)
    80006824:	7942                	ld	s2,48(sp)
    80006826:	79a2                	ld	s3,40(sp)
    80006828:	7a02                	ld	s4,32(sp)
    8000682a:	6ae2                	ld	s5,24(sp)
    8000682c:	6161                	addi	sp,sp,80
    8000682e:	8082                	ret
  for(i = 0; i < n; i++){
    80006830:	4901                	li	s2,0
    80006832:	b7ed                	j	8000681c <consolewrite+0x4a>

0000000080006834 <consoleread>:
...
{
    80006834:	7119                	addi	sp,sp,-128
    80006836:	fc86                	sd	ra,120(sp)
    80006838:	f8a2                	sd	s0,112(sp)
    8000683a:	f4a6                	sd	s1,104(sp)
    8000683c:	f0ca                	sd	s2,96(sp)
    8000683e:	ecce                	sd	s3,88(sp)
    80006840:	e8d2                	sd	s4,80(sp)
    80006842:	e4d6                	sd	s5,72(sp)
    80006844:	e0da                	sd	s6,64(sp)
    80006846:	fc5e                	sd	s7,56(sp)
    80006848:	f862                	sd	s8,48(sp)
    8000684a:	f466                	sd	s9,40(sp)
    8000684c:	f06a                	sd	s10,32(sp)
    8000684e:	ec6e                	sd	s11,24(sp)
    80006850:	0100                	addi	s0,sp,128
    80006852:	8b2a                	mv	s6,a0
    80006854:	8aae                	mv	s5,a1
    80006856:	8a32                	mv	s4,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    80006858:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    8000685c:	00021517          	auipc	a0,0x21
    80006860:	c2450513          	addi	a0,a0,-988 # 80027480 <cons>
    80006864:	00001097          	auipc	ra,0x1
    80006868:	8f4080e7          	jalr	-1804(ra) # 80007158 <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    8000686c:	00021497          	auipc	s1,0x21
    80006870:	c1448493          	addi	s1,s1,-1004 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    80006874:	89a6                	mv	s3,s1
    80006876:	00021917          	auipc	s2,0x21
    8000687a:	ca290913          	addi	s2,s2,-862 # 80027518 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    8000687e:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    80006882:	4da9                	li	s11,10
  while(n > 0){
    80006884:	07405863          	blez	s4,800068f4 <consoleread+0xc0>
    while(cons.r == cons.w){
    80006888:	0984a783          	lw	a5,152(s1)
    8000688c:	09c4a703          	lw	a4,156(s1)
    80006890:	02f71463          	bne	a4,a5,800068b8 <consoleread+0x84>
      if(myproc()->killed){
    80006894:	ffffa097          	auipc	ra,0xffffa
    80006898:	60c080e7          	jalr	1548(ra) # 80000ea0 <myproc>
    8000689c:	551c                	lw	a5,40(a0)
    8000689e:	e7b5                	bnez	a5,8000690a <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    800068a0:	85ce                	mv	a1,s3
    800068a2:	854a                	mv	a0,s2
    800068a4:	ffffb097          	auipc	ra,0xffffb
    800068a8:	cb8080e7          	jalr	-840(ra) # 8000155c <sleep>
    while(cons.r == cons.w){
    800068ac:	0984a783          	lw	a5,152(s1)
    800068b0:	09c4a703          	lw	a4,156(s1)
    800068b4:	fef700e3          	beq	a4,a5,80006894 <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    800068b8:	0017871b          	addiw	a4,a5,1
    800068bc:	08e4ac23          	sw	a4,152(s1)
    800068c0:	07f7f713          	andi	a4,a5,127
    800068c4:	9726                	add	a4,a4,s1
    800068c6:	01874703          	lbu	a4,24(a4)
    800068ca:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    800068ce:	079c0663          	beq	s8,s9,8000693a <consoleread+0x106>
    cbuf = c;
    800068d2:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    800068d6:	4685                	li	a3,1
    800068d8:	f8f40613          	addi	a2,s0,-113
    800068dc:	85d6                	mv	a1,s5
    800068de:	855a                	mv	a0,s6
    800068e0:	ffffb097          	auipc	ra,0xffffb
    800068e4:	020080e7          	jalr	32(ra) # 80001900 <either_copyout>
    800068e8:	01a50663          	beq	a0,s10,800068f4 <consoleread+0xc0>
    dst++;
    800068ec:	0a85                	addi	s5,s5,1
    --n;
    800068ee:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    800068f0:	f9bc1ae3          	bne	s8,s11,80006884 <consoleread+0x50>
  ...
  release(&cons.lock);
    ...
    80006900:	910080e7          	jalr	-1776(ra) # 8000720c <release>

  return target - n;
    80006904:	414b853b          	subw	a0,s7,s4
    80006908:	a811                	j	8000691c <consoleread+0xe8>
        release(&cons.lock);
    8000690a:	00021517          	auipc	a0,0x21
    8000690e:	b7650513          	addi	a0,a0,-1162 # 80027480 <cons>
    80006912:	00001097          	auipc	ra,0x1
    80006916:	8fa080e7          	jalr	-1798(ra) # 8000720c <release>
        return -1;
    8000691a:	557d                	li	a0,-1
}
    8000691c:	70e6                	ld	ra,120(sp)
    8000691e:	7446                	ld	s0,112(sp)
    80006920:	74a6                	ld	s1,104(sp)
    80006922:	7906                	ld	s2,96(sp)
    80006924:	69e6                	ld	s3,88(sp)
    80006926:	6a46                	ld	s4,80(sp)
    80006928:	6aa6                	ld	s5,72(sp)
    8000692a:	6b06                	ld	s6,64(sp)
    8000692c:	7be2                	ld	s7,56(sp)
    8000692e:	7c42                	ld	s8,48(sp)
    80006930:	7ca2                	ld	s9,40(sp)
    80006932:	7d02                	ld	s10,32(sp)
    80006934:	6de2                	ld	s11,24(sp)
    80006936:	6109                	addi	sp,sp,128
    80006938:	8082                	ret
      if(n < target){
    8000693a:	000a071b          	sext.w	a4,s4
    8000693e:	fb777be3          	bgeu	a4,s7,800068f4 <consoleread+0xc0>
        cons.r--;
    80006942:	00021717          	auipc	a4,0x21
    80006946:	bcf72b23          	sw	a5,-1066(a4) # 80027518 <cons+0x98>
    8000694a:	b76d                	j	800068f4 <consoleread+0xc0>

000000008000694c <consputc>:
{
    8000694c:	1141                	addi	sp,sp,-16
    8000694e:	e406                	sd	ra,8(sp)
    80006950:	e022                	sd	s0,0(sp)
    80006952:	0800                	addi	s0,sp,16
  if(c == BACKSPACE){
    80006954:	10000793          	li	a5,256
    80006958:	00f50a63          	beq	a0,a5,8000696c <consputc+0x20>
    uartputc_sync(c);
    8000695c:	00000097          	auipc	ra,0x0
    80006960:	564080e7          	jalr	1380(ra) # 80006ec0 <uartputc_sync>
}
    ...
    80006972:	552080e7          	jalr	1362(ra) # 80006ec0 <uartputc_sync>
    80006976:	02000513          	li	a0,32
    8000697a:	00000097          	auipc	ra,0x0
    8000697e:	546080e7          	jalr	1350(ra) # 80006ec0 <uartputc_sync>
    80006982:	4521                	li	a0,8
    80006984:	00000097          	auipc	ra,0x0
    80006988:	53c080e7          	jalr	1340(ra) # 80006ec0 <uartputc_sync>
    8000698c:	bfe1                	j	80006964 <consputc+0x18>

000000008000698e <consoleintr>:
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    800069a0:	ae450513          	addi	a0,a0,-1308 # 80027480 <cons>
    800069a4:	00000097          	auipc	ra,0x0
    800069a8:	7b4080e7          	jalr	1972(ra) # 80007158 <acquire>

  switch(c){
    800069ac:	47d5                	li	a5,21
    800069ae:	0af48663          	beq	s1,a5,80006a5a <consoleintr+0xcc>
    800069b2:	0297ca63          	blt	a5,s1,800069e6 <consoleintr+0x58>
    800069b6:	47a1                	li	a5,8
    800069b8:	0ef48763          	beq	s1,a5,80006aa6 <consoleintr+0x118>
    800069bc:	47c1                	li	a5,16
    800069be:	10f49a63          	bne	s1,a5,80006ad2 <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    800069c2:	ffffb097          	auipc	ra,0xffffb
    800069c6:	fea080e7          	jalr	-22(ra) # 800019ac <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    800069ca:	00021517          	auipc	a0,0x21
    800069ce:	ab650513          	addi	a0,a0,-1354 # 80027480 <cons>
    800069d2:	00001097          	auipc	ra,0x1
    800069d6:	83a080e7          	jalr	-1990(ra) # 8000720c <release>
}
    ...
    800069e4:	8082                	ret
  switch(c){
    800069e6:	07f00793          	li	a5,127
    800069ea:	0af48e63          	beq	s1,a5,80006aa6 <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    800069ee:	00021717          	auipc	a4,0x21
    800069f2:	a9270713          	addi	a4,a4,-1390 # 80027480 <cons>
    800069f6:	0a072783          	lw	a5,160(a4)
    800069fa:	09872703          	lw	a4,152(a4)
    800069fe:	9f99                	subw	a5,a5,a4
    80006a00:	07f00713          	li	a4,127
    80006a04:	fcf763e3          	bltu	a4,a5,800069ca <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    80006a08:	47b5                	li	a5,13
    80006a0a:	0cf48763          	beq	s1,a5,80006ad8 <consoleintr+0x14a>
      consputc(c);
    80006a0e:	8526                	mv	a0,s1
    80006a10:	00000097          	auipc	ra,0x0
    80006a14:	f3c080e7          	jalr	-196(ra) # 8000694c <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a18:	00021797          	auipc	a5,0x21
    80006a1c:	a6878793          	addi	a5,a5,-1432 # 80027480 <cons>
    80006a20:	0a07a703          	lw	a4,160(a5)
    80006a24:	0017069b          	addiw	a3,a4,1
    80006a28:	0006861b          	sext.w	a2,a3
    80006a2c:	0ad7a023          	sw	a3,160(a5)
    80006a30:	07f77713          	andi	a4,a4,127
    80006a34:	97ba                	add	a5,a5,a4
    80006a36:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    80006a3a:	47a9                	li	a5,10
    80006a3c:	0cf48563          	beq	s1,a5,80006b06 <consoleintr+0x178>
    80006a40:	4791                	li	a5,4
    80006a42:	0cf48263          	beq	s1,a5,80006b06 <consoleintr+0x178>
    80006a46:	00021797          	auipc	a5,0x21
    80006a4a:	ad27a783          	lw	a5,-1326(a5) # 80027518 <cons+0x98>
    80006a4e:	0807879b          	addiw	a5,a5,128
    80006a52:	f6f61ce3          	bne	a2,a5,800069ca <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a56:	863e                	mv	a2,a5
    80006a58:	a07d                	j	80006b06 <consoleintr+0x178>
    while(cons.e != cons.w &&
    80006a5a:	00021717          	auipc	a4,0x21
    80006a5e:	a2670713          	addi	a4,a4,-1498 # 80027480 <cons>
    80006a62:	0a072783          	lw	a5,160(a4)
    80006a66:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a6a:	00021497          	auipc	s1,0x21
    80006a6e:	a1648493          	addi	s1,s1,-1514 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a72:	4929                	li	s2,10
    80006a74:	f4f70be3          	beq	a4,a5,800069ca <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a78:	37fd                	addiw	a5,a5,-1
    80006a7a:	07f7f713          	andi	a4,a5,127
    80006a7e:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a80:	01874703          	lbu	a4,24(a4)
    80006a84:	f52703e3          	beq	a4,s2,800069ca <consoleintr+0x3c>
      cons.e--;
    80006a88:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006a8c:	10000513          	li	a0,256
    80006a90:	00000097          	auipc	ra,0x0
    80006a94:	ebc080e7          	jalr	-324(ra) # 8000694c <consputc>
    while(cons.e != cons.w &&
    80006a98:	0a04a783          	lw	a5,160(s1)
    80006a9c:	09c4a703          	lw	a4,156(s1)
    80006aa0:	fcf71ce3          	bne	a4,a5,80006a78 <consoleintr+0xea>
    80006aa4:	b71d                	j	800069ca <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006aa6:	00021717          	auipc	a4,0x21
    80006aaa:	9da70713          	addi	a4,a4,-1574 # 80027480 <cons>
    80006aae:	0a072783          	lw	a5,160(a4)
    80006ab2:	09c72703          	lw	a4,156(a4)
    80006ab6:	f0f70ae3          	beq	a4,a5,800069ca <consoleintr+0x3c>
      cons.e--;
    80006aba:	37fd                	addiw	a5,a5,-1
    80006abc:	00021717          	auipc	a4,0x21
    80006ac0:	a6f72223          	sw	a5,-1436(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006ac4:	10000513          	li	a0,256
    80006ac8:	00000097          	auipc	ra,0x0
    80006acc:	e84080e7          	jalr	-380(ra) # 8000694c <consputc>
    80006ad0:	bded                	j	800069ca <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006ad2:	ee048ce3          	beqz	s1,800069ca <consoleintr+0x3c>
    80006ad6:	bf21                	j	800069ee <consoleintr+0x60>
      consputc(c);
    80006ad8:	4529                	li	a0,10
    80006ada:	00000097          	auipc	ra,0x0
    80006ade:	e72080e7          	jalr	-398(ra) # 8000694c <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006ae2:	00021797          	auipc	a5,0x21
    80006ae6:	99e78793          	addi	a5,a5,-1634 # 80027480 <cons>
    80006aea:	0a07a703          	lw	a4,160(a5)
    80006aee:	0017069b          	addiw	a3,a4,1
    80006af2:	0006861b          	sext.w	a2,a3
    80006af6:	0ad7a023          	sw	a3,160(a5)
    80006afa:	07f77713          	andi	a4,a4,127
    80006afe:	97ba                	add	a5,a5,a4
    80006b00:	4729                	li	a4,10
    80006b02:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006b06:	00021797          	auipc	a5,0x21
    80006b0a:	a0c7ab23          	sw	a2,-1514(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006b0e:	00021517          	auipc	a0,0x21
    80006b12:	a0a50513          	addi	a0,a0,-1526 # 80027518 <cons+0x98>
    80006b16:	ffffb097          	auipc	ra,0xffffb
    80006b1a:	bd2080e7          	jalr	-1070(ra) # 800016e8 <wakeup>
    80006b1e:	b575                	j	800069ca <consoleintr+0x3c>

0000000080006b20 <consoleinit>:
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    80006b28:	00003597          	auipc	a1,0x3
    80006b2c:	d0858593          	addi	a1,a1,-760 # 80009830 <syscalls+0x458>
    80006b30:	00021517          	auipc	a0,0x21
    80006b34:	95050513          	addi	a0,a0,-1712 # 80027480 <cons>
    80006b38:	00000097          	auipc	ra,0x0
    80006b3c:	590080e7          	jalr	1424(ra) # 800070c8 <initlock>

  uartinit();
    80006b40:	00000097          	auipc	ra,0x0
    80006b44:	330080e7          	jalr	816(ra) # 80006e70 <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006b48:	00013797          	auipc	a5,0x13
    80006b4c:	5a078793          	addi	a5,a5,1440 # 8001a0e8 <devsw>
    80006b50:	00000717          	auipc	a4,0x0
    80006b54:	ce470713          	addi	a4,a4,-796 # 80006834 <consoleread>
    80006b58:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b5a:	00000717          	auipc	a4,0x0
    80006b5e:	c7870713          	addi	a4,a4,-904 # 800067d2 <consolewrite>
    80006b62:	ef98                	sd	a4,24(a5)
}
...
{
    80006b6c:	7179                	addi	sp,sp,-48
    80006b6e:	f406                	sd	ra,40(sp)
    80006b70:	f022                	sd	s0,32(sp)
    80006b72:	ec26                	sd	s1,24(sp)
    80006b74:	e84a                	sd	s2,16(sp)
    80006b76:	1800                	addi	s0,sp,48
  char buf[16];
  int i;
  uint x;

  if(sign && (sign = xx < 0))
    80006b78:	c219                	beqz	a2,80006b7e <printint+0x12>
    80006b7a:	08054663          	bltz	a0,80006c06 <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b7e:	2501                	sext.w	a0,a0
    80006b80:	4881                	li	a7,0
    80006b82:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b86:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b88:	2581                	sext.w	a1,a1
    80006b8a:	00003617          	auipc	a2,0x3
    80006b8e:	cd660613          	addi	a2,a2,-810 # 80009860 <digits>
    80006b92:	883a                	mv	a6,a4
    80006b94:	2705                	addiw	a4,a4,1
    80006b96:	02b577bb          	remuw	a5,a0,a1
    80006b9a:	1782                	slli	a5,a5,0x20
    80006b9c:	9381                	srli	a5,a5,0x20
    80006b9e:	97b2                	add	a5,a5,a2
    80006ba0:	0007c783          	lbu	a5,0(a5)
    80006ba4:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006ba8:	0005079b          	sext.w	a5,a0
    80006bac:	02b5553b          	divuw	a0,a0,a1
    80006bb0:	0685                	addi	a3,a3,1
    80006bb2:	feb7f0e3          	bgeu	a5,a1,80006b92 <printint+0x26>

  if(sign)
    80006bb6:	00088b63          	beqz	a7,80006bcc <printint+0x60>
    buf[i++] = '-';
    80006bba:	fe040793          	addi	a5,s0,-32
    80006bbe:	973e                	add	a4,a4,a5
    80006bc0:	02d00793          	li	a5,45
    80006bc4:	fef70823          	sb	a5,-16(a4)
    80006bc8:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006bcc:	02e05763          	blez	a4,80006bfa <printint+0x8e>
    80006bd0:	fd040793          	addi	a5,s0,-48
    80006bd4:	00e784b3          	add	s1,a5,a4
    80006bd8:	fff78913          	addi	s2,a5,-1
    80006bdc:	993a                	add	s2,s2,a4
    80006bde:	377d                	addiw	a4,a4,-1
    80006be0:	1702                	slli	a4,a4,0x20
    80006be2:	9301                	srli	a4,a4,0x20
    80006be4:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006be8:	fff4c503          	lbu	a0,-1(s1)
    80006bec:	00000097          	auipc	ra,0x0
    80006bf0:	d60080e7          	jalr	-672(ra) # 8000694c <consputc>
  while(--i >= 0)
    80006bf4:	14fd                	addi	s1,s1,-1
    80006bf6:	ff2499e3          	bne	s1,s2,80006be8 <printint+0x7c>
}
    80006bfa:	70a2                	ld	ra,40(sp)
    80006bfc:	7402                	ld	s0,32(sp)
    80006bfe:	64e2                	ld	s1,24(sp)
    80006c00:	6942                	ld	s2,16(sp)
    80006c02:	6145                	addi	sp,sp,48
    80006c04:	8082                	ret
    x = -xx;
    80006c06:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006c0a:	4885                	li	a7,1
    x = -xx;
    80006c0c:	bf9d                	j	80006b82 <printint+0x16>

0000000080006c0e <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
    ...
    80006c14:	e426                	sd	s1,8(sp)
    80006c16:	1000                	addi	s0,sp,32
    80006c18:	84aa                	mv	s1,a0
  pr.locking = 0;
    80006c1a:	00021797          	auipc	a5,0x21
    80006c1e:	9207a323          	sw	zero,-1754(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006c22:	00003517          	auipc	a0,0x3
    80006c26:	c1650513          	addi	a0,a0,-1002 # 80009838 <syscalls+0x460>
    80006c2a:	00000097          	auipc	ra,0x0
    80006c2e:	02e080e7          	jalr	46(ra) # 80006c58 <printf>
  printf(s);
    80006c32:	8526                	mv	a0,s1
    80006c34:	00000097          	auipc	ra,0x0
    80006c38:	024080e7          	jalr	36(ra) # 80006c58 <printf>
  printf("\n");
    80006c3c:	00002517          	auipc	a0,0x2
    80006c40:	40c50513          	addi	a0,a0,1036 # 80009048 <etext+0x48>
    80006c44:	00000097          	auipc	ra,0x0
    80006c48:	014080e7          	jalr	20(ra) # 80006c58 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006c4c:	4785                	li	a5,1
    80006c4e:	00003717          	auipc	a4,0x3
    80006c52:	3ef72123          	sw	a5,994(a4) # 8000a030 <panicked>
  for(;;)
    80006c56:	a001                	j	80006c56 <panic+0x48>

0000000080006c58 <printf>:
{
    80006c58:	7131                	addi	sp,sp,-192
    80006c5a:	fc86                	sd	ra,120(sp)
    80006c5c:	f8a2                	sd	s0,112(sp)
    80006c5e:	f4a6                	sd	s1,104(sp)
    80006c60:	f0ca                	sd	s2,96(sp)
    80006c62:	ecce                	sd	s3,88(sp)
    80006c64:	e8d2                	sd	s4,80(sp)
    80006c66:	e4d6                	sd	s5,72(sp)
    80006c68:	e0da                	sd	s6,64(sp)
    80006c6a:	fc5e                	sd	s7,56(sp)
    80006c6c:	f862                	sd	s8,48(sp)
    80006c6e:	f466                	sd	s9,40(sp)
    80006c70:	f06a                	sd	s10,32(sp)
    80006c72:	ec6e                	sd	s11,24(sp)
    80006c74:	0100                	addi	s0,sp,128
    80006c76:	8a2a                	mv	s4,a0
    80006c78:	e40c                	sd	a1,8(s0)
    80006c7a:	e810                	sd	a2,16(s0)
    80006c7c:	ec14                	sd	a3,24(s0)
    80006c7e:	f018                	sd	a4,32(s0)
    80006c80:	f41c                	sd	a5,40(s0)
    80006c82:	03043823          	sd	a6,48(s0)
    80006c86:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006c8a:	00021d97          	auipc	s11,0x21
    80006c8e:	8b6dad83          	lw	s11,-1866(s11) # 80027540 <pr+0x18>
  if(locking)
    80006c92:	020d9b63          	bnez	s11,80006cc8 <printf+0x70>
  if (fmt == 0)
    80006c96:	040a0263          	beqz	s4,80006cda <printf+0x82>
  va_start(ap, fmt);
    80006c9a:	00840793          	addi	a5,s0,8
    80006c9e:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006ca2:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006ca6:	16050263          	beqz	a0,80006e0a <printf+0x1b2>
    80006caa:	4481                	li	s1,0
    if(c != '%'){
    80006cac:	02500a93          	li	s5,37
    switch(c){
    80006cb0:	07000b13          	li	s6,112
  consputc('x');
    80006cb4:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006cb6:	00003b97          	auipc	s7,0x3
    80006cba:	baab8b93          	addi	s7,s7,-1110 # 80009860 <digits>
    switch(c){
    80006cbe:	07300c93          	li	s9,115
    80006cc2:	06400c13          	li	s8,100
    80006cc6:	a82d                	j	80006d00 <printf+0xa8>
    acquire(&pr.lock);
    80006cc8:	00021517          	auipc	a0,0x21
    80006ccc:	86050513          	addi	a0,a0,-1952 # 80027528 <pr>
    80006cd0:	00000097          	auipc	ra,0x0
    80006cd4:	488080e7          	jalr	1160(ra) # 80007158 <acquire>
    80006cd8:	bf7d                	j	80006c96 <printf+0x3e>
    panic("null fmt");
    80006cda:	00003517          	auipc	a0,0x3
    80006cde:	b6e50513          	addi	a0,a0,-1170 # 80009848 <syscalls+0x470>
    80006ce2:	00000097          	auipc	ra,0x0
    80006ce6:	f2c080e7          	jalr	-212(ra) # 80006c0e <panic>
      consputc(c);
    80006cea:	00000097          	auipc	ra,0x0
    80006cee:	c62080e7          	jalr	-926(ra) # 8000694c <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006cf2:	2485                	addiw	s1,s1,1
    80006cf4:	009a07b3          	add	a5,s4,s1
    80006cf8:	0007c503          	lbu	a0,0(a5)
    80006cfc:	10050763          	beqz	a0,80006e0a <printf+0x1b2>
    if(c != '%'){
    80006d00:	ff5515e3          	bne	a0,s5,80006cea <printf+0x92>
    c = fmt[++i] & 0xff;
    80006d04:	2485                	addiw	s1,s1,1
    80006d06:	009a07b3          	add	a5,s4,s1
    80006d0a:	0007c783          	lbu	a5,0(a5)
    80006d0e:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006d12:	cfe5                	beqz	a5,80006e0a <printf+0x1b2>
    switch(c){
    80006d14:	05678a63          	beq	a5,s6,80006d68 <printf+0x110>
    80006d18:	02fb7663          	bgeu	s6,a5,80006d44 <printf+0xec>
    80006d1c:	09978963          	beq	a5,s9,80006dae <printf+0x156>
    80006d20:	07800713          	li	a4,120
    80006d24:	0ce79863          	bne	a5,a4,80006df4 <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006d28:	f8843783          	ld	a5,-120(s0)
    80006d2c:	00878713          	addi	a4,a5,8
    80006d30:	f8e43423          	sd	a4,-120(s0)
    80006d34:	4605                	li	a2,1
    80006d36:	85ea                	mv	a1,s10
    80006d38:	4388                	lw	a0,0(a5)
    80006d3a:	00000097          	auipc	ra,0x0
    80006d3e:	e32080e7          	jalr	-462(ra) # 80006b6c <printint>
      break;
    80006d42:	bf45                	j	80006cf2 <printf+0x9a>
    switch(c){
    80006d44:	0b578263          	beq	a5,s5,80006de8 <printf+0x190>
    80006d48:	0b879663          	bne	a5,s8,80006df4 <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006d4c:	f8843783          	ld	a5,-120(s0)
    80006d50:	00878713          	addi	a4,a5,8
    80006d54:	f8e43423          	sd	a4,-120(s0)
    80006d58:	4605                	li	a2,1
    80006d5a:	45a9                	li	a1,10
    80006d5c:	4388                	lw	a0,0(a5)
    80006d5e:	00000097          	auipc	ra,0x0
    80006d62:	e0e080e7          	jalr	-498(ra) # 80006b6c <printint>
      break;
    80006d66:	b771                	j	80006cf2 <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d68:	f8843783          	ld	a5,-120(s0)
    80006d6c:	00878713          	addi	a4,a5,8
    80006d70:	f8e43423          	sd	a4,-120(s0)
    80006d74:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d78:	03000513          	li	a0,48
    80006d7c:	00000097          	auipc	ra,0x0
    80006d80:	bd0080e7          	jalr	-1072(ra) # 8000694c <consputc>
  consputc('x');
    80006d84:	07800513          	li	a0,120
    80006d88:	00000097          	auipc	ra,0x0
    80006d8c:	bc4080e7          	jalr	-1084(ra) # 8000694c <consputc>
    80006d90:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006d92:	03c9d793          	srli	a5,s3,0x3c
    80006d96:	97de                	add	a5,a5,s7
    80006d98:	0007c503          	lbu	a0,0(a5)
    80006d9c:	00000097          	auipc	ra,0x0
    80006da0:	bb0080e7          	jalr	-1104(ra) # 8000694c <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006da4:	0992                	slli	s3,s3,0x4
    80006da6:	397d                	addiw	s2,s2,-1
    80006da8:	fe0915e3          	bnez	s2,80006d92 <printf+0x13a>
    80006dac:	b799                	j	80006cf2 <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006dae:	f8843783          	ld	a5,-120(s0)
    80006db2:	00878713          	addi	a4,a5,8
    80006db6:	f8e43423          	sd	a4,-120(s0)
    80006dba:	0007b903          	ld	s2,0(a5)
    80006dbe:	00090e63          	beqz	s2,80006dda <printf+0x182>
      for(; *s; s++)
    80006dc2:	00094503          	lbu	a0,0(s2)
    80006dc6:	d515                	beqz	a0,80006cf2 <printf+0x9a>
        consputc(*s);
    80006dc8:	00000097          	auipc	ra,0x0
    80006dcc:	b84080e7          	jalr	-1148(ra) # 8000694c <consputc>
      for(; *s; s++)
    80006dd0:	0905                	addi	s2,s2,1
    80006dd2:	00094503          	lbu	a0,0(s2)
    80006dd6:	f96d                	bnez	a0,80006dc8 <printf+0x170>
    80006dd8:	bf29                	j	80006cf2 <printf+0x9a>
        s = "(null)";
    80006dda:	00003917          	auipc	s2,0x3
    80006dde:	a6690913          	addi	s2,s2,-1434 # 80009840 <syscalls+0x468>
      for(; *s; s++)
    80006de2:	02800513          	li	a0,40
    80006de6:	b7cd                	j	80006dc8 <printf+0x170>
      consputc('%');
    80006de8:	8556                	mv	a0,s5
    80006dea:	00000097          	auipc	ra,0x0
    80006dee:	b62080e7          	jalr	-1182(ra) # 8000694c <consputc>
      break;
    80006df2:	b701                	j	80006cf2 <printf+0x9a>
      consputc('%');
    80006df4:	8556                	mv	a0,s5
    80006df6:	00000097          	auipc	ra,0x0
    80006dfa:	b56080e7          	jalr	-1194(ra) # 8000694c <consputc>
      consputc(c);
    80006dfe:	854a                	mv	a0,s2
    80006e00:	00000097          	auipc	ra,0x0
    80006e04:	b4c080e7          	jalr	-1204(ra) # 8000694c <consputc>
      break;
    80006e08:	b5ed                	j	80006cf2 <printf+0x9a>
  if(locking)
    80006e0a:	020d9163          	bnez	s11,80006e2c <printf+0x1d4>
}
    80006e0e:	70e6                	ld	ra,120(sp)
    80006e10:	7446                	ld	s0,112(sp)
    80006e12:	74a6                	ld	s1,104(sp)
    80006e14:	7906                	ld	s2,96(sp)
    80006e16:	69e6                	ld	s3,88(sp)
    80006e18:	6a46                	ld	s4,80(sp)
    80006e1a:	6aa6                	ld	s5,72(sp)
    80006e1c:	6b06                	ld	s6,64(sp)
    80006e1e:	7be2                	ld	s7,56(sp)
    80006e20:	7c42                	ld	s8,48(sp)
    80006e22:	7ca2                	ld	s9,40(sp)
    80006e24:	7d02                	ld	s10,32(sp)
    80006e26:	6de2                	ld	s11,24(sp)
    80006e28:	6129                	addi	sp,sp,192
    80006e2a:	8082                	ret
    release(&pr.lock);
    80006e2c:	00020517          	auipc	a0,0x20
    80006e30:	6fc50513          	addi	a0,a0,1788 # 80027528 <pr>
    80006e34:	00000097          	auipc	ra,0x0
    80006e38:	3d8080e7          	jalr	984(ra) # 8000720c <release>
}
    80006e3c:	bfc9                	j	80006e0e <printf+0x1b6>

0000000080006e3e <printfinit>:
    ;
}
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    80006e48:	00020497          	auipc	s1,0x20
    80006e4c:	6e048493          	addi	s1,s1,1760 # 80027528 <pr>
    80006e50:	00003597          	auipc	a1,0x3
    80006e54:	a0858593          	addi	a1,a1,-1528 # 80009858 <syscalls+0x480>
    80006e58:	8526                	mv	a0,s1
    80006e5a:	00000097          	auipc	ra,0x0
    80006e5e:	26e080e7          	jalr	622(ra) # 800070c8 <initlock>
  pr.locking = 1;
    80006e62:	4785                	li	a5,1
    80006e64:	cc9c                	sw	a5,24(s1)
}
    80006e66:	60e2                	ld	ra,24(sp)
    80006e68:	6442                	ld	s0,16(sp)
    80006e6a:	64a2                	ld	s1,8(sp)
    80006e6c:	6105                	addi	sp,sp,32
    80006e6e:	8082                	ret

0000000080006e70 <uartinit>:
...
uartinit(void)
{
    80006e70:	1141                	addi	sp,sp,-16
    80006e72:	e406                	sd	ra,8(sp)
    80006e74:	e022                	sd	s0,0(sp)
    80006e76:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e78:	100007b7          	lui	a5,0x10000
    80006e7c:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e80:	f8000713          	li	a4,-128
    80006e84:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80006e88:	470d                	li	a4,3
    80006e8a:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80006e8e:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006e92:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006e96:	469d                	li	a3,7
    80006e98:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006e9c:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006ea0:	00003597          	auipc	a1,0x3
    80006ea4:	9d858593          	addi	a1,a1,-1576 # 80009878 <digits+0x18>
    80006ea8:	00020517          	auipc	a0,0x20
    80006eac:	6a050513          	addi	a0,a0,1696 # 80027548 <uart_tx_lock>
    80006eb0:	00000097          	auipc	ra,0x0
    80006eb4:	218080e7          	jalr	536(ra) # 800070c8 <initlock>
}
...
0000000080006ec0 <uartputc_sync>:
...
uartputc_sync(int c)
{
    80006ec0:	1101                	addi	sp,sp,-32
    80006ec2:	ec06                	sd	ra,24(sp)
    80006ec4:	e822                	sd	s0,16(sp)
    80006ec6:	e426                	sd	s1,8(sp)
    80006ec8:	1000                	addi	s0,sp,32
    80006eca:	84aa                	mv	s1,a0
  push_off();
    80006ecc:	00000097          	auipc	ra,0x0
    80006ed0:	240080e7          	jalr	576(ra) # 8000710c <push_off>

  if(panicked){
    80006ed4:	00003797          	auipc	a5,0x3
    80006ed8:	15c7a783          	lw	a5,348(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  if(panicked){
    80006ee0:	c391                	beqz	a5,80006ee4 <uartputc_sync+0x24>
    for(;;)
    80006ee2:	a001                	j	80006ee2 <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006ee4:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006ee8:	0ff7f793          	andi	a5,a5,255
    80006eec:	0207f793          	andi	a5,a5,32
    80006ef0:	dbf5                	beqz	a5,80006ee4 <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006ef2:	0ff4f793          	andi	a5,s1,255
    80006ef6:	10000737          	lui	a4,0x10000
    80006efa:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006efe:	00000097          	auipc	ra,0x0
    80006f02:	2ae080e7          	jalr	686(ra) # 800071ac <pop_off>
}
...
uartstart()
{
  while(1){
    ...
    80006f10:	00003717          	auipc	a4,0x3
    80006f14:	12873703          	ld	a4,296(a4) # 8000a038 <uart_tx_r>
    80006f18:	00003797          	auipc	a5,0x3
    80006f1c:	1287b783          	ld	a5,296(a5) # 8000a040 <uart_tx_w>
    80006f20:	06e78c63          	beq	a5,a4,80006f98 <uartstart+0x88>
{
    80006f24:	7139                	addi	sp,sp,-64
    80006f26:	fc06                	sd	ra,56(sp)
    80006f28:	f822                	sd	s0,48(sp)
    80006f2a:	f426                	sd	s1,40(sp)
    80006f2c:	f04a                	sd	s2,32(sp)
    80006f2e:	ec4e                	sd	s3,24(sp)
    80006f30:	e852                	sd	s4,16(sp)
    80006f32:	e456                	sd	s5,8(sp)
    80006f34:	0080                	addi	s0,sp,64
      // transmit buffer is empty.
      return;
    }
    
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f36:	10000937          	lui	s2,0x10000
    ...
    80006f3a:	00020a17          	auipc	s4,0x20
    80006f3e:	60ea0a13          	addi	s4,s4,1550 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006f42:	00003497          	auipc	s1,0x3
    80006f46:	0f648493          	addi	s1,s1,246 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006f4a:	00003997          	auipc	s3,0x3
    80006f4e:	0f698993          	addi	s3,s3,246 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f52:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f56:	0ff7f793          	andi	a5,a5,255
    80006f5a:	0207f793          	andi	a5,a5,32
    80006f5e:	c785                	beqz	a5,80006f86 <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f60:	01f77793          	andi	a5,a4,31
    80006f64:	97d2                	add	a5,a5,s4
    80006f66:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f6a:	0705                	addi	a4,a4,1
    80006f6c:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f6e:	8526                	mv	a0,s1
    80006f70:	ffffa097          	auipc	ra,0xffffa
    80006f74:	778080e7          	jalr	1912(ra) # 800016e8 <wakeup>
    
    WriteReg(THR, c);
    80006f78:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f7c:	6098                	ld	a4,0(s1)
    80006f7e:	0009b783          	ld	a5,0(s3)
    80006f82:	fce798e3          	bne	a5,a4,80006f52 <uartstart+0x42>
  }
}
    80006f86:	70e2                	ld	ra,56(sp)
    80006f88:	7442                	ld	s0,48(sp)
    80006f8a:	74a2                	ld	s1,40(sp)
    80006f8c:	7902                	ld	s2,32(sp)
    80006f8e:	69e2                	ld	s3,24(sp)
    80006f90:	6a42                	ld	s4,16(sp)
    80006f92:	6aa2                	ld	s5,8(sp)
    80006f94:	6121                	addi	sp,sp,64
    80006f96:	8082                	ret
    80006f98:	8082                	ret

0000000080006f9a <uartputc>:
{
    80006f9a:	7179                	addi	sp,sp,-48
    80006f9c:	f406                	sd	ra,40(sp)
    80006f9e:	f022                	sd	s0,32(sp)
    80006fa0:	ec26                	sd	s1,24(sp)
    80006fa2:	e84a                	sd	s2,16(sp)
    80006fa4:	e44e                	sd	s3,8(sp)
    80006fa6:	e052                	sd	s4,0(sp)
    80006fa8:	1800                	addi	s0,sp,48
    80006faa:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006fac:	00020517          	auipc	a0,0x20
    80006fb0:	59c50513          	addi	a0,a0,1436 # 80027548 <uart_tx_lock>
    80006fb4:	00000097          	auipc	ra,0x0
    80006fb8:	1a4080e7          	jalr	420(ra) # 80007158 <acquire>
  if(panicked){
    80006fbc:	00003797          	auipc	a5,0x3
    80006fc0:	0747a783          	lw	a5,116(a5) # 8000a030 <panicked>
    80006fc4:	c391                	beqz	a5,80006fc8 <uartputc+0x2e>
    for(;;)
    80006fc6:	a001                	j	80006fc6 <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fc8:	00003797          	auipc	a5,0x3
    80006fcc:	0787b783          	ld	a5,120(a5) # 8000a040 <uart_tx_w>
    80006fd0:	00003717          	auipc	a4,0x3
    80006fd4:	06873703          	ld	a4,104(a4) # 8000a038 <uart_tx_r>
    80006fd8:	02070713          	addi	a4,a4,32
    80006fdc:	02f71b63          	bne	a4,a5,80007012 <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fe0:	00020a17          	auipc	s4,0x20
    80006fe4:	568a0a13          	addi	s4,s4,1384 # 80027548 <uart_tx_lock>
    80006fe8:	00003497          	auipc	s1,0x3
    80006fec:	05048493          	addi	s1,s1,80 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006ff0:	00003917          	auipc	s2,0x3
    80006ff4:	05090913          	addi	s2,s2,80 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006ff8:	85d2                	mv	a1,s4
    80006ffa:	8526                	mv	a0,s1
    80006ffc:	ffffa097          	auipc	ra,0xffffa
    80007000:	560080e7          	jalr	1376(ra) # 8000155c <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80007004:	00093783          	ld	a5,0(s2)
    80007008:	6098                	ld	a4,0(s1)
    8000700a:	02070713          	addi	a4,a4,32
    8000700e:	fef705e3          	beq	a4,a5,80006ff8 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80007012:	00020497          	auipc	s1,0x20
    80007016:	53648493          	addi	s1,s1,1334 # 80027548 <uart_tx_lock>
    8000701a:	01f7f713          	andi	a4,a5,31
    8000701e:	9726                	add	a4,a4,s1
    80007020:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    80007024:	0785                	addi	a5,a5,1
    80007026:	00003717          	auipc	a4,0x3
    8000702a:	00f73d23          	sd	a5,26(a4) # 8000a040 <uart_tx_w>
      uartstart();
    8000702e:	00000097          	auipc	ra,0x0
    80007032:	ee2080e7          	jalr	-286(ra) # 80006f10 <uartstart>
      release(&uart_tx_lock);
    80007036:	8526                	mv	a0,s1
    80007038:	00000097          	auipc	ra,0x0
    8000703c:	1d4080e7          	jalr	468(ra) # 8000720c <release>
}
    80007040:	70a2                	ld	ra,40(sp)
    80007042:	7402                	ld	s0,32(sp)
    80007044:	64e2                	ld	s1,24(sp)
    80007046:	6942                	ld	s2,16(sp)
    80007048:	69a2                	ld	s3,8(sp)
    8000704a:	6a02                	ld	s4,0(sp)
    8000704c:	6145                	addi	sp,sp,48
    8000704e:	8082                	ret

0000000080007050 <uartgetc>:
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & 0x01){
    80007056:	100007b7          	lui	a5,0x10000
    8000705a:	0057c783          	lbu	a5,5(a5) # 10000005 <_entry-0x6ffffffb>
    8000705e:	8b85                	andi	a5,a5,1
    80007060:	cb91                	beqz	a5,80007074 <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    80007062:	100007b7          	lui	a5,0x10000
    80007066:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    8000706a:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    8000706e:	6422                	ld	s0,8(sp)
    80007070:	0141                	addi	sp,sp,16
    80007072:	8082                	ret
    return -1;
    80007074:	557d                	li	a0,-1
    80007076:	bfe5                	j	8000706e <uartgetc+0x1e>

0000000080007078 <uartintr>:
...
uartintr(void)
{
    ...
    8000707e:	e426                	sd	s1,8(sp)
    80007080:	1000                	addi	s0,sp,32
  // read and process incoming characters.
  while(1){
    int c = uartgetc();
    if(c == -1)
    80007082:	54fd                	li	s1,-1
    int c = uartgetc();
    80007084:	00000097          	auipc	ra,0x0
    80007088:	fcc080e7          	jalr	-52(ra) # 80007050 <uartgetc>
    if(c == -1)
    8000708c:	00950763          	beq	a0,s1,8000709a <uartintr+0x22>
      break;
    consoleintr(c);
    80007090:	00000097          	auipc	ra,0x0
    80007094:	8fe080e7          	jalr	-1794(ra) # 8000698e <consoleintr>
  while(1){
    80007098:	b7f5                	j	80007084 <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    8000709a:	00020497          	auipc	s1,0x20
    8000709e:	4ae48493          	addi	s1,s1,1198 # 80027548 <uart_tx_lock>
    800070a2:	8526                	mv	a0,s1
    800070a4:	00000097          	auipc	ra,0x0
    800070a8:	0b4080e7          	jalr	180(ra) # 80007158 <acquire>
  uartstart();
    800070ac:	00000097          	auipc	ra,0x0
    800070b0:	e64080e7          	jalr	-412(ra) # 80006f10 <uartstart>
  release(&uart_tx_lock);
    800070b4:	8526                	mv	a0,s1
    800070b6:	00000097          	auipc	ra,0x0
    800070ba:	156080e7          	jalr	342(ra) # 8000720c <release>
}
...
{
    800070c8:	1141                	addi	sp,sp,-16
    800070ca:	e422                	sd	s0,8(sp)
    800070cc:	0800                	addi	s0,sp,16
  lk->name = name;
    800070ce:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    800070d0:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    800070d4:	00053823          	sd	zero,16(a0)
#ifdef LAB_LOCK
  lk->nts = 0;
  lk->n = 0;
  findslot(lk);
    ...
    800070d8:	6422                	ld	s0,8(sp)
    800070da:	0141                	addi	sp,sp,16
    800070dc:	8082                	ret

00000000800070de <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    800070de:	411c                	lw	a5,0(a0)
    800070e0:	e399                	bnez	a5,800070e6 <holding+0x8>
    800070e2:	4501                	li	a0,0
  return r;
}
    800070e4:	8082                	ret
{
    800070e6:	1101                	addi	sp,sp,-32
    800070e8:	ec06                	sd	ra,24(sp)
    800070ea:	e822                	sd	s0,16(sp)
    800070ec:	e426                	sd	s1,8(sp)
    800070ee:	1000                	addi	s0,sp,32
  r = (lk->locked && lk->cpu == mycpu());
    800070f0:	6904                	ld	s1,16(a0)
    800070f2:	ffffa097          	auipc	ra,0xffffa
    800070f6:	d92080e7          	jalr	-622(ra) # 80000e84 <mycpu>
    800070fa:	40a48533          	sub	a0,s1,a0
    800070fe:	00153513          	seqz	a0,a0
}
    80007102:	60e2                	ld	ra,24(sp)
    80007104:	6442                	ld	s0,16(sp)
    80007106:	64a2                	ld	s1,8(sp)
    80007108:	6105                	addi	sp,sp,32
    8000710a:	8082                	ret

000000008000710c <push_off>:
...
push_off(void)
{
  ...
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80007116:	100024f3          	csrr	s1,sstatus
    8000711a:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    8000711e:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
  ...
  if(mycpu()->noff == 0)
    ...
    80007128:	d60080e7          	jalr	-672(ra) # 80000e84 <mycpu>
    8000712c:	5d3c                	lw	a5,120(a0)
    8000712e:	cf89                	beqz	a5,80007148 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    80007130:	ffffa097          	auipc	ra,0xffffa
    80007134:	d54080e7          	jalr	-684(ra) # 80000e84 <mycpu>
    80007138:	5d3c                	lw	a5,120(a0)
    8000713a:	2785                	addiw	a5,a5,1
    8000713c:	dd3c                	sw	a5,120(a0)
}
    8000713e:	60e2                	ld	ra,24(sp)
    80007140:	6442                	ld	s0,16(sp)
    80007142:	64a2                	ld	s1,8(sp)
    80007144:	6105                	addi	sp,sp,32
    80007146:	8082                	ret
    mycpu()->intena = old;
    80007148:	ffffa097          	auipc	ra,0xffffa
    8000714c:	d3c080e7          	jalr	-708(ra) # 80000e84 <mycpu>
  return (x & SSTATUS_SIE) != 0;
    80007150:	8085                	srli	s1,s1,0x1
    80007152:	8885                	andi	s1,s1,1
    80007154:	dd64                	sw	s1,124(a0)
    80007156:	bfe9                	j	80007130 <push_off+0x24>

0000000080007158 <acquire>:
{
    80007158:	1101                	addi	sp,sp,-32
    8000715a:	ec06                	sd	ra,24(sp)
    8000715c:	e822                	sd	s0,16(sp)
    8000715e:	e426                	sd	s1,8(sp)
    80007160:	1000                	addi	s0,sp,32
    80007162:	84aa                	mv	s1,a0
  push_off(); // disable interrupts to avoid deadlock.
    80007164:	00000097          	auipc	ra,0x0
    80007168:	fa8080e7          	jalr	-88(ra) # 8000710c <push_off>
  if(holding(lk))
    8000716c:	8526                	mv	a0,s1
    8000716e:	00000097          	auipc	ra,0x0
    80007172:	f70080e7          	jalr	-144(ra) # 800070de <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007176:	4705                	li	a4,1
  if(holding(lk))
    80007178:	e115                	bnez	a0,8000719c <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    8000717a:	87ba                	mv	a5,a4
    8000717c:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    80007180:	2781                	sext.w	a5,a5
    80007182:	ffe5                	bnez	a5,8000717a <acquire+0x22>
  __sync_synchronize();
    80007184:	0ff0000f          	fence
  lk->cpu = mycpu();
    80007188:	ffffa097          	auipc	ra,0xffffa
    8000718c:	cfc080e7          	jalr	-772(ra) # 80000e84 <mycpu>
    80007190:	e888                	sd	a0,16(s1)
}
    80007192:	60e2                	ld	ra,24(sp)
    80007194:	6442                	ld	s0,16(sp)
    80007196:	64a2                	ld	s1,8(sp)
    80007198:	6105                	addi	sp,sp,32
    8000719a:	8082                	ret
    panic("acquire");
    8000719c:	00002517          	auipc	a0,0x2
    800071a0:	6e450513          	addi	a0,a0,1764 # 80009880 <digits+0x20>
    800071a4:	00000097          	auipc	ra,0x0
    800071a8:	a6a080e7          	jalr	-1430(ra) # 80006c0e <panic>

00000000800071ac <pop_off>:

void
pop_off(void)
{
    800071ac:	1141                	addi	sp,sp,-16
    800071ae:	e406                	sd	ra,8(sp)
    800071b0:	e022                	sd	s0,0(sp)
    800071b2:	0800                	addi	s0,sp,16
  struct cpu *c = mycpu();
    800071b4:	ffffa097          	auipc	ra,0xffffa
    800071b8:	cd0080e7          	jalr	-816(ra) # 80000e84 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071bc:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    800071c0:	8b89                	andi	a5,a5,2
  if(intr_get())
    800071c2:	e78d                	bnez	a5,800071ec <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    800071c4:	5d3c                	lw	a5,120(a0)
    800071c6:	02f05b63          	blez	a5,800071fc <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    800071ca:	37fd                	addiw	a5,a5,-1
    800071cc:	0007871b          	sext.w	a4,a5
    800071d0:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    800071d2:	eb09                	bnez	a4,800071e4 <pop_off+0x38>
    800071d4:	5d7c                	lw	a5,124(a0)
    800071d6:	c799                	beqz	a5,800071e4 <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071d8:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800071dc:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800071e0:	10079073          	csrw	sstatus,a5
    intr_on();
}
    800071e4:	60a2                	ld	ra,8(sp)
    800071e6:	6402                	ld	s0,0(sp)
    800071e8:	0141                	addi	sp,sp,16
    800071ea:	8082                	ret
    panic("pop_off - interruptible");
    800071ec:	00002517          	auipc	a0,0x2
    800071f0:	69c50513          	addi	a0,a0,1692 # 80009888 <digits+0x28>
    800071f4:	00000097          	auipc	ra,0x0
    800071f8:	a1a080e7          	jalr	-1510(ra) # 80006c0e <panic>
    panic("pop_off");
    800071fc:	00002517          	auipc	a0,0x2
    80007200:	6a450513          	addi	a0,a0,1700 # 800098a0 <digits+0x40>
    80007204:	00000097          	auipc	ra,0x0
    80007208:	a0a080e7          	jalr	-1526(ra) # 80006c0e <panic>

000000008000720c <release>:
{
    8000720c:	1101                	addi	sp,sp,-32
    8000720e:	ec06                	sd	ra,24(sp)
    80007210:	e822                	sd	s0,16(sp)
    80007212:	e426                	sd	s1,8(sp)
    80007214:	1000                	addi	s0,sp,32
    80007216:	84aa                	mv	s1,a0
  if(!holding(lk))
    80007218:	00000097          	auipc	ra,0x0
    8000721c:	ec6080e7          	jalr	-314(ra) # 800070de <holding>
    80007220:	c115                	beqz	a0,80007244 <release+0x38>
  lk->cpu = 0;
    80007222:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    80007226:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    8000722a:	0f50000f          	fence	iorw,ow
    8000722e:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    80007232:	00000097          	auipc	ra,0x0
    80007236:	f7a080e7          	jalr	-134(ra) # 800071ac <pop_off>
}
    8000723a:	60e2                	ld	ra,24(sp)
    8000723c:	6442                	ld	s0,16(sp)
    8000723e:	64a2                	ld	s1,8(sp)
    80007240:	6105                	addi	sp,sp,32
    80007242:	8082                	ret
    panic("release");
    80007244:	00002517          	auipc	a0,0x2
    80007248:	66450513          	addi	a0,a0,1636 # 800098a8 <digits+0x48>
    8000724c:	00000097          	auipc	ra,0x0
    80007250:	9c2080e7          	jalr	-1598(ra) # 80006c0e <panic>

0000000080007254 <lockfree_read8>:
...
lockfree_read8(uint64 *addr) {
  ...
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    ...
    8000725e:	6108                	ld	a0,0(a0)
    80007260:	0ff0000f          	fence
  return val;
}
    80007264:	6422                	ld	s0,8(sp)
    80007266:	0141                	addi	sp,sp,16
    80007268:	8082                	ret

000000008000726a <lockfree_read4>:
...
lockfree_read4(int *addr) {
  ...
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    ...
    80007274:	4108                	lw	a0,0(a0)
    80007276:	0ff0000f          	fence
  return val;
}
    8000727a:	2501                	sext.w	a0,a0
